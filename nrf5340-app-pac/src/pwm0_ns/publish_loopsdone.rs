#[doc = "Reader of register PUBLISH_LOOPSDONE"]
pub type R = crate::R<u32, super::PUBLISH_LOOPSDONE>;
#[doc = "Writer for register PUBLISH_LOOPSDONE"]
pub type W = crate::W<u32, super::PUBLISH_LOOPSDONE>;
#[doc = "Register PUBLISH_LOOPSDONE `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_LOOPSDONE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event LOOPSDONE will publish to."]
    #[inline(always)]
