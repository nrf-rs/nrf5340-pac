#[doc = "Reader of register SUBSCRIBE_NEXTSTEP"]
pub type R = crate::R<u32, super::SUBSCRIBE_NEXTSTEP>;
#[doc = "Writer for register SUBSCRIBE_NEXTSTEP"]
pub type W = crate::W<u32, super::SUBSCRIBE_NEXTSTEP>;
#[doc = "Register SUBSCRIBE_NEXTSTEP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_NEXTSTEP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task NEXTSTEP will subscribe to"]
    #[inline(always)]
