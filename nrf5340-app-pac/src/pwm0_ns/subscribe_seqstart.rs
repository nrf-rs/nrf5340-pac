#[doc = "Reader of register SUBSCRIBE_SEQSTART[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_SEQSTART>;
#[doc = "Writer for register SUBSCRIBE_SEQSTART[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_SEQSTART>;
#[doc = "Register SUBSCRIBE_SEQSTART[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SEQSTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SEQSTART\\[n\\] will subscribe to"]
    #[inline(always)]
