#[doc = "Reader of register PUBLISH_ENDEPOUT[%s]"]
pub type R = crate::R<u32, super::PUBLISH_ENDEPOUT>;
#[doc = "Writer for register PUBLISH_ENDEPOUT[%s]"]
pub type W = crate::W<u32, super::PUBLISH_ENDEPOUT>;
#[doc = "Register PUBLISH_ENDEPOUT[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDEPOUT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDEPOUT\\[n\\] will publish to."]
    #[inline(always)]
