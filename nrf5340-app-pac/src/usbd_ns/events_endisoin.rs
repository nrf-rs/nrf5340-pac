...
impl core::convert::From<crate::R<EVENTS_ENDISOIN_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ENDISOIN_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_ENDISOIN_R {
    type Target = crate::FieldReader<bool, EVENTS_ENDISOIN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
