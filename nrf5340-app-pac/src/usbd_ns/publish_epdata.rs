#[doc = "Reader of register PUBLISH_EPDATA"]
pub type R = crate::R<u32, super::PUBLISH_EPDATA>;
#[doc = "Writer for register PUBLISH_EPDATA"]
pub type W = crate::W<u32, super::PUBLISH_EPDATA>;
#[doc = "Register PUBLISH_EPDATA `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_EPDATA {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event EPDATA will publish to."]
    #[inline(always)]
