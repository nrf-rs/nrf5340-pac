#[doc = "Reader of register SUBSCRIBE_DPDMDRIVE"]
pub type R = crate::R<u32, super::SUBSCRIBE_DPDMDRIVE>;
#[doc = "Writer for register SUBSCRIBE_DPDMDRIVE"]
pub type W = crate::W<u32, super::SUBSCRIBE_DPDMDRIVE>;
#[doc = "Register SUBSCRIBE_DPDMDRIVE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_DPDMDRIVE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task DPDMDRIVE will subscribe to"]
    #[inline(always)]
