...
impl core::convert::From<crate::R<EVENTS_USBRESET_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_USBRESET_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_USBRESET_R {
    type Target = crate::FieldReader<bool, EVENTS_USBRESET_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
