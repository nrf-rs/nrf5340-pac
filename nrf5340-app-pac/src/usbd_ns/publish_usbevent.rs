#[doc = "Reader of register PUBLISH_USBEVENT"]
pub type R = crate::R<u32, super::PUBLISH_USBEVENT>;
#[doc = "Writer for register PUBLISH_USBEVENT"]
pub type W = crate::W<u32, super::PUBLISH_USBEVENT>;
#[doc = "Register PUBLISH_USBEVENT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_USBEVENT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event USBEVENT will publish to."]
    #[inline(always)]
