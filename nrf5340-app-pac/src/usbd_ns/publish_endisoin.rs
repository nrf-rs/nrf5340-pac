#[doc = "Reader of register PUBLISH_ENDISOIN"]
pub type R = crate::R<u32, super::PUBLISH_ENDISOIN>;
#[doc = "Writer for register PUBLISH_ENDISOIN"]
pub type W = crate::W<u32, super::PUBLISH_ENDISOIN>;
#[doc = "Register PUBLISH_ENDISOIN `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDISOIN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDISOIN will publish to."]
    #[inline(always)]
