#[doc = "Reader of register SUBSCRIBE_EP0STALL"]
pub type R = crate::R<u32, super::SUBSCRIBE_EP0STALL>;
#[doc = "Writer for register SUBSCRIBE_EP0STALL"]
pub type W = crate::W<u32, super::SUBSCRIBE_EP0STALL>;
#[doc = "Register SUBSCRIBE_EP0STALL `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_EP0STALL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task EP0STALL will subscribe to"]
    #[inline(always)]
