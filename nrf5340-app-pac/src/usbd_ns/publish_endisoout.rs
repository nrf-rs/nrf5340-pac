#[doc = "Reader of register PUBLISH_ENDISOOUT"]
pub type R = crate::R<u32, super::PUBLISH_ENDISOOUT>;
#[doc = "Writer for register PUBLISH_ENDISOOUT"]
pub type W = crate::W<u32, super::PUBLISH_ENDISOOUT>;
#[doc = "Register PUBLISH_ENDISOOUT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDISOOUT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDISOOUT will publish to."]
    #[inline(always)]
