#[doc = "Reader of register SUBSCRIBE_EP0STATUS"]
pub type R = crate::R<u32, super::SUBSCRIBE_EP0STATUS>;
#[doc = "Writer for register SUBSCRIBE_EP0STATUS"]
pub type W = crate::W<u32, super::SUBSCRIBE_EP0STATUS>;
#[doc = "Register SUBSCRIBE_EP0STATUS `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_EP0STATUS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task EP0STATUS will subscribe to"]
    #[inline(always)]
