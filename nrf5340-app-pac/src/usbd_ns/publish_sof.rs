#[doc = "Reader of register PUBLISH_SOF"]
pub type R = crate::R<u32, super::PUBLISH_SOF>;
#[doc = "Writer for register PUBLISH_SOF"]
pub type W = crate::W<u32, super::PUBLISH_SOF>;
#[doc = "Register PUBLISH_SOF `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SOF {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SOF will publish to."]
    #[inline(always)]
