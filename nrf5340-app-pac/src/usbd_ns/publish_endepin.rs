#[doc = "Reader of register PUBLISH_ENDEPIN[%s]"]
pub type R = crate::R<u32, super::PUBLISH_ENDEPIN>;
#[doc = "Writer for register PUBLISH_ENDEPIN[%s]"]
pub type W = crate::W<u32, super::PUBLISH_ENDEPIN>;
#[doc = "Register PUBLISH_ENDEPIN[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDEPIN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDEPIN\\[n\\] will publish to."]
    #[inline(always)]
