#[doc = "Reader of register PUBLISH_EP0SETUP"]
pub type R = crate::R<u32, super::PUBLISH_EP0SETUP>;
#[doc = "Writer for register PUBLISH_EP0SETUP"]
pub type W = crate::W<u32, super::PUBLISH_EP0SETUP>;
#[doc = "Register PUBLISH_EP0SETUP `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_EP0SETUP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event EP0SETUP will publish to."]
    #[inline(always)]
