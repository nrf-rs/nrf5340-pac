#[doc = "Reader of register PUBLISH_USBRESET"]
pub type R = crate::R<u32, super::PUBLISH_USBRESET>;
#[doc = "Writer for register PUBLISH_USBRESET"]
pub type W = crate::W<u32, super::PUBLISH_USBRESET>;
#[doc = "Register PUBLISH_USBRESET `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_USBRESET {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event USBRESET will publish to."]
    #[inline(always)]
