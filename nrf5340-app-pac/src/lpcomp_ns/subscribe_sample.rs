#[doc = "Reader of register SUBSCRIBE_SAMPLE"]
pub type R = crate::R<u32, super::SUBSCRIBE_SAMPLE>;
#[doc = "Writer for register SUBSCRIBE_SAMPLE"]
pub type W = crate::W<u32, super::SUBSCRIBE_SAMPLE>;
#[doc = "Register SUBSCRIBE_SAMPLE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SAMPLE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SAMPLE will subscribe to"]
    #[inline(always)]
