#[doc = "Reader of register PUBLISH_UP"]
pub type R = crate::R<u32, super::PUBLISH_UP>;
#[doc = "Writer for register PUBLISH_UP"]
pub type W = crate::W<u32, super::PUBLISH_UP>;
#[doc = "Register PUBLISH_UP `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_UP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event UP will publish to."]
    #[inline(always)]
