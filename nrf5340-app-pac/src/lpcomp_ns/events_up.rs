...
impl core::convert::From<crate::R<EVENTS_UP_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_UP_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_UP_R {
    type Target = crate::FieldReader<bool, EVENTS_UP_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
