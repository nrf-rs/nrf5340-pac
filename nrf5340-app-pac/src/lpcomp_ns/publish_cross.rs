#[doc = "Reader of register PUBLISH_CROSS"]
pub type R = crate::R<u32, super::PUBLISH_CROSS>;
#[doc = "Writer for register PUBLISH_CROSS"]
pub type W = crate::W<u32, super::PUBLISH_CROSS>;
#[doc = "Register PUBLISH_CROSS `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CROSS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CROSS will publish to."]
    #[inline(always)]
