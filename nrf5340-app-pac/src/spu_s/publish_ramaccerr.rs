#[doc = "Reader of register PUBLISH_RAMACCERR"]
pub type R = crate::R<u32, super::PUBLISH_RAMACCERR>;
#[doc = "Writer for register PUBLISH_RAMACCERR"]
pub type W = crate::W<u32, super::PUBLISH_RAMACCERR>;
#[doc = "Register PUBLISH_RAMACCERR `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RAMACCERR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RAMACCERR will publish to."]
    #[inline(always)]
