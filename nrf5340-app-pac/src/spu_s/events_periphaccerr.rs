...
impl core::convert::From<crate::R<EVENTS_PERIPHACCERR_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_PERIPHACCERR_SPEC>> for W {
...
pub struct EVENTS_PERIPHACCERR_R(crate::FieldReader<bool, EVENTS_PERIPHACCERR_A>);
impl EVENTS_PERIPHACCERR_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_PERIPHACCERR_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_PERIPHACCERR_R {
    type Target = crate::FieldReader<bool, EVENTS_PERIPHACCERR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
