...
impl core::convert::From<crate::R<REGION_SPEC>> for R {
...
impl core::convert::From<crate::W<REGION_SPEC>> for W {
...
impl R {
    #[doc = "Bits 0:5 - Region number"]
    #[inline(always)]
    pub fn region(&self) -> REGION_R {
        REGION_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
