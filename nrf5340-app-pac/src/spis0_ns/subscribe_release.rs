#[doc = "Reader of register SUBSCRIBE_RELEASE"]
pub type R = crate::R<u32, super::SUBSCRIBE_RELEASE>;
#[doc = "Writer for register SUBSCRIBE_RELEASE"]
pub type W = crate::W<u32, super::SUBSCRIBE_RELEASE>;
#[doc = "Register SUBSCRIBE_RELEASE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RELEASE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RELEASE will subscribe to"]
    #[inline(always)]
