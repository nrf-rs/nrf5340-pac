#[doc = "Reader of register PUBLISH_ACQUIRED"]
pub type R = crate::R<u32, super::PUBLISH_ACQUIRED>;
#[doc = "Writer for register PUBLISH_ACQUIRED"]
pub type W = crate::W<u32, super::PUBLISH_ACQUIRED>;
#[doc = "Register PUBLISH_ACQUIRED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ACQUIRED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ACQUIRED will publish to."]
    #[inline(always)]
