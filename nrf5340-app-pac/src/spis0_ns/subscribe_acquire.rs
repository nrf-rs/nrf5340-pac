#[doc = "Reader of register SUBSCRIBE_ACQUIRE"]
pub type R = crate::R<u32, super::SUBSCRIBE_ACQUIRE>;
#[doc = "Writer for register SUBSCRIBE_ACQUIRE"]
pub type W = crate::W<u32, super::SUBSCRIBE_ACQUIRE>;
#[doc = "Register SUBSCRIBE_ACQUIRE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_ACQUIRE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task ACQUIRE will subscribe to"]
    #[inline(always)]
