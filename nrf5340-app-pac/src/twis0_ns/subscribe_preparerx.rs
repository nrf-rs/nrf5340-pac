...
pub struct R(crate::R<SUBSCRIBE_PREPARERX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SUBSCRIBE_PREPARERX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<SUBSCRIBE_PREPARERX_SPEC>> for R {
    fn from(reader: crate::R<SUBSCRIBE_PREPARERX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SUBSCRIBE_PREPARERX` writer"]
pub struct W(crate::W<SUBSCRIBE_PREPARERX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SUBSCRIBE_PREPARERX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<SUBSCRIBE_PREPARERX_SPEC>> for W {
    fn from(writer: crate::W<SUBSCRIBE_PREPARERX_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Subscribe configuration for task PREPARERX\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [subscribe_preparerx](index.html) module"]
pub struct SUBSCRIBE_PREPARERX_SPEC;
impl crate::RegisterSpec for SUBSCRIBE_PREPARERX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [subscribe_preparerx::R](R) reader structure"]
impl crate::Readable for SUBSCRIBE_PREPARERX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [subscribe_preparerx::W](W) writer structure"]
impl crate::Writable for SUBSCRIBE_PREPARERX_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SUBSCRIBE_PREPARERX to value 0"]
impl crate::Resettable for SUBSCRIBE_PREPARERX_SPEC {
    #[inline(always)]
