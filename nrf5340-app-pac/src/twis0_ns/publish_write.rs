#[doc = "Reader of register PUBLISH_WRITE"]
pub type R = crate::R<u32, super::PUBLISH_WRITE>;
#[doc = "Writer for register PUBLISH_WRITE"]
pub type W = crate::W<u32, super::PUBLISH_WRITE>;
#[doc = "Register PUBLISH_WRITE `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_WRITE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event WRITE will publish to."]
    #[inline(always)]
