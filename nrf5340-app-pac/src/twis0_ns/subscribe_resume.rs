#[doc = "Reader of register SUBSCRIBE_RESUME"]
pub type R = crate::R<u32, super::SUBSCRIBE_RESUME>;
#[doc = "Writer for register SUBSCRIBE_RESUME"]
pub type W = crate::W<u32, super::SUBSCRIBE_RESUME>;
#[doc = "Register SUBSCRIBE_RESUME `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RESUME {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RESUME will subscribe to"]
    #[inline(always)]
