#[doc = "Reader of register SUBSCRIBE_SUSPEND"]
pub type R = crate::R<u32, super::SUBSCRIBE_SUSPEND>;
#[doc = "Writer for register SUBSCRIBE_SUSPEND"]
pub type W = crate::W<u32, super::SUBSCRIBE_SUSPEND>;
#[doc = "Register SUBSCRIBE_SUSPEND `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SUSPEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SUSPEND will subscribe to"]
    #[inline(always)]
