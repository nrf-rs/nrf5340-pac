#[doc = "Reader of register SUBSCRIBE_PREPARETX"]
pub type R = crate::R<u32, super::SUBSCRIBE_PREPARETX>;
#[doc = "Writer for register SUBSCRIBE_PREPARETX"]
pub type W = crate::W<u32, super::SUBSCRIBE_PREPARETX>;
#[doc = "Register SUBSCRIBE_PREPARETX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_PREPARETX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task PREPARETX will subscribe to"]
    #[inline(always)]
