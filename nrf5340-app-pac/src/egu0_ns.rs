...
event"]
    ...
    pub subscribe_trigger: [crate::Reg<subscribe_trigger::SUBSCRIBE_TRIGGER_SPEC>; 16],
...
task"]
    ...
    pub publish_triggered: [crate::Reg<publish_triggered::PUBLISH_TRIGGERED_SPEC>; 16],
...
#[doc = "SUBSCRIBE_TRIGGER register accessor: an alias for `Reg<SUBSCRIBE_TRIGGER_SPEC>`"]
pub type SUBSCRIBE_TRIGGER = crate::Reg<subscribe_trigger::SUBSCRIBE_TRIGGER_SPEC>;
...
#[doc = "PUBLISH_TRIGGERED register accessor: an alias for `Reg<PUBLISH_TRIGGERED_SPEC>`"]
pub type PUBLISH_TRIGGERED = crate::Reg<publish_triggered::PUBLISH_TRIGGERED_SPEC>;
