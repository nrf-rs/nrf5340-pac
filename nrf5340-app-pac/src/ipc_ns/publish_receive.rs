#[doc = "Reader of register PUBLISH_RECEIVE[%s]"]
pub type R = crate::R<u32, super::PUBLISH_RECEIVE>;
#[doc = "Writer for register PUBLISH_RECEIVE[%s]"]
pub type W = crate::W<u32, super::PUBLISH_RECEIVE>;
#[doc = "Register PUBLISH_RECEIVE[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RECEIVE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RECEIVE\\[n\\] will publish to."]
    #[inline(always)]
