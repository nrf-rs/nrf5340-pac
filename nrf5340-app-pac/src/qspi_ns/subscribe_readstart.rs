#[doc = "Reader of register SUBSCRIBE_READSTART"]
pub type R = crate::R<u32, super::SUBSCRIBE_READSTART>;
#[doc = "Writer for register SUBSCRIBE_READSTART"]
pub type W = crate::W<u32, super::SUBSCRIBE_READSTART>;
#[doc = "Register SUBSCRIBE_READSTART `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_READSTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task READSTART will subscribe to"]
    #[inline(always)]
