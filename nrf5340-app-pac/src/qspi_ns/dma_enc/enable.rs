...
pub enum ENABLE_A {
    #[doc = "0: Disable stream cipher for QSPI EasyDMA"]
    DISABLED = 0,
    #[doc = "1: Enable stream cipher for QSPI EasyDMA"]
    ENABLED = 1,
}
...
#[doc = "Field `ENABLE` writer - Enable or disable stream cipher for EasyDMA"]
...
impl R {
    #[doc = "Bit 0 - Enable or disable stream cipher for EasyDMA"]
    #[inline(always)]
