#[doc = "Register `HFCLKAUDIOALWAYSRUN` reader"]
pub struct R(crate::R<HFCLKAUDIOALWAYSRUN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFCLKAUDIOALWAYSRUN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<HFCLKAUDIOALWAYSRUN_SPEC>> for R {
    fn from(reader: crate::R<HFCLKAUDIOALWAYSRUN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HFCLKAUDIOALWAYSRUN` writer"]
pub struct W(crate::W<HFCLKAUDIOALWAYSRUN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HFCLKAUDIOALWAYSRUN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<HFCLKAUDIOALWAYSRUN_SPEC>> for W {
    fn from(writer: crate::W<HFCLKAUDIOALWAYSRUN_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Automatic or manual control of HFCLKAUDIO\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfclkaudioalwaysrun](index.html) module"]
pub struct HFCLKAUDIOALWAYSRUN_SPEC;
impl crate::RegisterSpec for HFCLKAUDIOALWAYSRUN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfclkaudioalwaysrun::R](R) reader structure"]
impl crate::Readable for HFCLKAUDIOALWAYSRUN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hfclkaudioalwaysrun::W](W) writer structure"]
impl crate::Writable for HFCLKAUDIOALWAYSRUN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HFCLKAUDIOALWAYSRUN to value 0"]
impl crate::Resettable for HFCLKAUDIOALWAYSRUN_SPEC {
    #[inline(always)]
