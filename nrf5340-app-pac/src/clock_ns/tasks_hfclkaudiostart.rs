...
pub struct W(crate::W<TASKS_HFCLKAUDIOSTART_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TASKS_HFCLKAUDIOSTART_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<TASKS_HFCLKAUDIOSTART_SPEC>> for W {
    fn from(writer: crate::W<TASKS_HFCLKAUDIOSTART_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Start HFCLKAUDIO source\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tasks_hfclkaudiostart](index.html) module"]
pub struct TASKS_HFCLKAUDIOSTART_SPEC;
impl crate::RegisterSpec for TASKS_HFCLKAUDIOSTART_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [tasks_hfclkaudiostart::W](W) writer structure"]
impl crate::Writable for TASKS_HFCLKAUDIOSTART_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TASKS_HFCLKAUDIOSTART to value 0"]
impl crate::Resettable for TASKS_HFCLKAUDIOSTART_SPEC {
    #[inline(always)]
