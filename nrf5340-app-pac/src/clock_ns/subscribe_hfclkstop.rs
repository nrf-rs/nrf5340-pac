#[doc = "Reader of register SUBSCRIBE_HFCLKSTOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_HFCLKSTOP>;
#[doc = "Writer for register SUBSCRIBE_HFCLKSTOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_HFCLKSTOP>;
#[doc = "Register SUBSCRIBE_HFCLKSTOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_HFCLKSTOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task HFCLKSTOP will subscribe to"]
    #[inline(always)]
