...
impl core::convert::From<crate::R<EVENTS_HFCLK192MSTARTED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_HFCLK192MSTARTED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_HFCLK192MSTARTED_R {
    type Target = crate::FieldReader<bool, EVENTS_HFCLK192MSTARTED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
