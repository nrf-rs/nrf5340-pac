...
pub struct W(crate::W<TASKS_HFCLKAUDIOSTOP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TASKS_HFCLKAUDIOSTOP_SPEC>;
    #[inline(always)]
...
impl core::convert::From<crate::W<TASKS_HFCLKAUDIOSTOP_SPEC>> for W {
    fn from(writer: crate::W<TASKS_HFCLKAUDIOSTOP_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Stop HFCLKAUDIO source\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tasks_hfclkaudiostop](index.html) module"]
pub struct TASKS_HFCLKAUDIOSTOP_SPEC;
impl crate::RegisterSpec for TASKS_HFCLKAUDIOSTOP_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [tasks_hfclkaudiostop::W](W) writer structure"]
impl crate::Writable for TASKS_HFCLKAUDIOSTOP_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TASKS_HFCLKAUDIOSTOP to value 0"]
impl crate::Resettable for TASKS_HFCLKAUDIOSTOP_SPEC {
    #[inline(always)]
