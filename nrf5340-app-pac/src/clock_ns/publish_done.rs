...
pub struct R(crate::R<PUBLISH_DONE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PUBLISH_DONE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PUBLISH_DONE_SPEC>> for R {
    fn from(reader: crate::R<PUBLISH_DONE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PUBLISH_DONE` writer"]
pub struct W(crate::W<PUBLISH_DONE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PUBLISH_DONE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PUBLISH_DONE_SPEC>> for W {
    fn from(writer: crate::W<PUBLISH_DONE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Publish configuration for event DONE\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [publish_done](index.html) module"]
pub struct PUBLISH_DONE_SPEC;
impl crate::RegisterSpec for PUBLISH_DONE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [publish_done::R](R) reader structure"]
impl crate::Readable for PUBLISH_DONE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [publish_done::W](W) writer structure"]
impl crate::Writable for PUBLISH_DONE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PUBLISH_DONE to value 0"]
impl crate::Resettable for PUBLISH_DONE_SPEC {
    #[inline(always)]
