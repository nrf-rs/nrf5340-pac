#[doc = "Reader of register PUBLISH_TXPTRUPD"]
pub type R = crate::R<u32, super::PUBLISH_TXPTRUPD>;
#[doc = "Writer for register PUBLISH_TXPTRUPD"]
pub type W = crate::W<u32, super::PUBLISH_TXPTRUPD>;
#[doc = "Register PUBLISH_TXPTRUPD `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXPTRUPD {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXPTRUPD will publish to."]
    #[inline(always)]
