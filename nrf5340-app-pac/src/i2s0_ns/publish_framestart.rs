#[doc = "Reader of register PUBLISH_FRAMESTART"]
pub type R = crate::R<u32, super::PUBLISH_FRAMESTART>;
#[doc = "Writer for register PUBLISH_FRAMESTART"]
pub type W = crate::W<u32, super::PUBLISH_FRAMESTART>;
#[doc = "Register PUBLISH_FRAMESTART `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_FRAMESTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event FRAMESTART will publish to."]
    #[inline(always)]
