#[doc = "Reader of register PUBLISH_STOPPED"]
pub type R = crate::R<u32, super::PUBLISH_STOPPED>;
#[doc = "Writer for register PUBLISH_STOPPED"]
pub type W = crate::W<u32, super::PUBLISH_STOPPED>;
#[doc = "Register PUBLISH_STOPPED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_STOPPED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event STOPPED will publish to."]
    #[inline(always)]
