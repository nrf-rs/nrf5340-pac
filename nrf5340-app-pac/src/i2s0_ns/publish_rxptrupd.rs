#[doc = "Reader of register PUBLISH_RXPTRUPD"]
pub type R = crate::R<u32, super::PUBLISH_RXPTRUPD>;
#[doc = "Writer for register PUBLISH_RXPTRUPD"]
pub type W = crate::W<u32, super::PUBLISH_RXPTRUPD>;
#[doc = "Register PUBLISH_RXPTRUPD `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXPTRUPD {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXPTRUPD will publish to."]
    #[inline(always)]
