...
impl core::convert::From<crate::R<EVENTS_RXPTRUPD_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_RXPTRUPD_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_RXPTRUPD_R {
    type Target = crate::FieldReader<bool, EVENTS_RXPTRUPD_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
