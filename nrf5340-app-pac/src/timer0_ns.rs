...
register"]
    pub tasks_capture: [crate::Reg<tasks_capture::TASKS_CAPTURE_SPEC>; 6],
    ...
    pub subscribe_capture: [crate::Reg<subscribe_capture::SUBSCRIBE_CAPTURE_SPEC>; 6],
    _reserved12: [u8; 104usize],
    #[doc = "0x140 - Description collection: Compare event on CC\\[n\\]
match"]
    pub events_compare: [crate::Reg<events_compare::EVENTS_COMPARE_SPEC>; 6],
    _reserved13: [u8; 104usize],
    #[doc = "0x1c0 - Description collection: Publish configuration for event COMPARE\\[n\\]"]
    pub publish_compare: [crate::Reg<publish_compare::PUBLISH_COMPARE_SPEC>; 6],
    ...
    _reserved21: [u8; 44usize],
    #[doc = "0x540 - Description collection: Capture/Compare register n"]
    pub cc: [crate::Reg<cc::CC_SPEC>; 6],
    _reserved22: [u8; 40usize],
    #[doc = "0x580 - Description collection: Enable one-shot operation for Capture/Compare channel n"]
    pub oneshoten: [crate::Reg<oneshoten::ONESHOTEN_SPEC>; 6],
}
