#[doc = "Reader of register PUBLISH_SLEEPENTER"]
pub type R = crate::R<u32, super::PUBLISH_SLEEPENTER>;
#[doc = "Writer for register PUBLISH_SLEEPENTER"]
pub type W = crate::W<u32, super::PUBLISH_SLEEPENTER>;
#[doc = "Register PUBLISH_SLEEPENTER `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SLEEPENTER {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SLEEPENTER will publish to."]
    #[inline(always)]
