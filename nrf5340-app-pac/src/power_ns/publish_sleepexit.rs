#[doc = "Reader of register PUBLISH_SLEEPEXIT"]
pub type R = crate::R<u32, super::PUBLISH_SLEEPEXIT>;
#[doc = "Writer for register PUBLISH_SLEEPEXIT"]
pub type W = crate::W<u32, super::PUBLISH_SLEEPEXIT>;
#[doc = "Register PUBLISH_SLEEPEXIT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SLEEPEXIT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SLEEPEXIT will publish to."]
    #[inline(always)]
