#[doc = "Reader of register SUBSCRIBE_CONSTLAT"]
pub type R = crate::R<u32, super::SUBSCRIBE_CONSTLAT>;
#[doc = "Writer for register SUBSCRIBE_CONSTLAT"]
pub type W = crate::W<u32, super::SUBSCRIBE_CONSTLAT>;
#[doc = "Register SUBSCRIBE_CONSTLAT `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CONSTLAT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CONSTLAT will subscribe to"]
    #[inline(always)]
