#[doc = "Reader of register PUBLISH_ACCOF"]
pub type R = crate::R<u32, super::PUBLISH_ACCOF>;
#[doc = "Writer for register PUBLISH_ACCOF"]
pub type W = crate::W<u32, super::PUBLISH_ACCOF>;
#[doc = "Register PUBLISH_ACCOF `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ACCOF {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ACCOF will publish to."]
    #[inline(always)]
