#[doc = "Reader of register PUBLISH_DBLRDY"]
pub type R = crate::R<u32, super::PUBLISH_DBLRDY>;
#[doc = "Writer for register PUBLISH_DBLRDY"]
pub type W = crate::W<u32, super::PUBLISH_DBLRDY>;
#[doc = "Register PUBLISH_DBLRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DBLRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DBLRDY will publish to."]
    #[inline(always)]
