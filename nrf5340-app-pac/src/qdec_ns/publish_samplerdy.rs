#[doc = "Reader of register PUBLISH_SAMPLERDY"]
pub type R = crate::R<u32, super::PUBLISH_SAMPLERDY>;
#[doc = "Writer for register PUBLISH_SAMPLERDY"]
pub type W = crate::W<u32, super::PUBLISH_SAMPLERDY>;
#[doc = "Register PUBLISH_SAMPLERDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SAMPLERDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SAMPLERDY will publish to."]
    #[inline(always)]
