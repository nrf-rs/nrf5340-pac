#[doc = "Reader of register SUBSCRIBE_RDCLRDBL"]
pub type R = crate::R<u32, super::SUBSCRIBE_RDCLRDBL>;
#[doc = "Writer for register SUBSCRIBE_RDCLRDBL"]
pub type W = crate::W<u32, super::SUBSCRIBE_RDCLRDBL>;
#[doc = "Register SUBSCRIBE_RDCLRDBL `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RDCLRDBL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RDCLRDBL will subscribe to"]
    #[inline(always)]
