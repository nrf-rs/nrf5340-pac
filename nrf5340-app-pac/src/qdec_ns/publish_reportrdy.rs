#[doc = "Reader of register PUBLISH_REPORTRDY"]
pub type R = crate::R<u32, super::PUBLISH_REPORTRDY>;
#[doc = "Writer for register PUBLISH_REPORTRDY"]
pub type W = crate::W<u32, super::PUBLISH_REPORTRDY>;
#[doc = "Register PUBLISH_REPORTRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_REPORTRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event REPORTRDY will publish to."]
    #[inline(always)]
