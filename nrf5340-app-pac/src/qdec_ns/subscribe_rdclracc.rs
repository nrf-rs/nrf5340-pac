#[doc = "Reader of register SUBSCRIBE_RDCLRACC"]
pub type R = crate::R<u32, super::SUBSCRIBE_RDCLRACC>;
#[doc = "Writer for register SUBSCRIBE_RDCLRACC"]
pub type W = crate::W<u32, super::SUBSCRIBE_RDCLRACC>;
#[doc = "Register SUBSCRIBE_RDCLRACC `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RDCLRACC {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RDCLRACC will subscribe to"]
    #[inline(always)]
