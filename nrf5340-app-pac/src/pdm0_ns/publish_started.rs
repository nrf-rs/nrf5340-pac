#[doc = "Reader of register PUBLISH_STARTED"]
pub type R = crate::R<u32, super::PUBLISH_STARTED>;
#[doc = "Writer for register PUBLISH_STARTED"]
pub type W = crate::W<u32, super::PUBLISH_STARTED>;
#[doc = "Register PUBLISH_STARTED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_STARTED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event STARTED will publish to."]
    #[inline(always)]
