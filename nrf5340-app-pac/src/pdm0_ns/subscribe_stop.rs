#[doc = "Reader of register SUBSCRIBE_STOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_STOP>;
#[doc = "Writer for register SUBSCRIBE_STOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_STOP>;
#[doc = "Register SUBSCRIBE_STOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STOP will subscribe to"]
    #[inline(always)]
