...
impl core::convert::From<crate::R<EVENTS_FIELDDETECTED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_FIELDDETECTED_SPEC>> for W {
...
pub struct EVENTS_FIELDDETECTED_R(crate::FieldReader<bool, EVENTS_FIELDDETECTED_A>);
impl EVENTS_FIELDDETECTED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_FIELDDETECTED_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_FIELDDETECTED_R {
    type Target = crate::FieldReader<bool, EVENTS_FIELDDETECTED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
