#[doc = "Reader of register PUBLISH_TXFRAMEEND"]
pub type R = crate::R<u32, super::PUBLISH_TXFRAMEEND>;
#[doc = "Writer for register PUBLISH_TXFRAMEEND"]
pub type W = crate::W<u32, super::PUBLISH_TXFRAMEEND>;
#[doc = "Register PUBLISH_TXFRAMEEND `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXFRAMEEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXFRAMEEND will publish to."]
    #[inline(always)]
