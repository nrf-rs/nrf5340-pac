#[doc = "Reader of register SUBSCRIBE_SENSE"]
pub type R = crate::R<u32, super::SUBSCRIBE_SENSE>;
#[doc = "Writer for register SUBSCRIBE_SENSE"]
pub type W = crate::W<u32, super::SUBSCRIBE_SENSE>;
#[doc = "Register SUBSCRIBE_SENSE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SENSE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SENSE will subscribe to"]
    #[inline(always)]
