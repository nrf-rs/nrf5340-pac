#[doc = "Reader of register PUBLISH_RXERROR"]
pub type R = crate::R<u32, super::PUBLISH_RXERROR>;
#[doc = "Writer for register PUBLISH_RXERROR"]
pub type W = crate::W<u32, super::PUBLISH_RXERROR>;
#[doc = "Register PUBLISH_RXERROR `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXERROR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXERROR will publish to."]
    #[inline(always)]
