#[doc = "Reader of register SUBSCRIBE_ACTIVATE"]
pub type R = crate::R<u32, super::SUBSCRIBE_ACTIVATE>;
#[doc = "Writer for register SUBSCRIBE_ACTIVATE"]
pub type W = crate::W<u32, super::SUBSCRIBE_ACTIVATE>;
#[doc = "Register SUBSCRIBE_ACTIVATE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_ACTIVATE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task ACTIVATE will subscribe to"]
    #[inline(always)]
