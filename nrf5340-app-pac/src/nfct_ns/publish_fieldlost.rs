#[doc = "Reader of register PUBLISH_FIELDLOST"]
pub type R = crate::R<u32, super::PUBLISH_FIELDLOST>;
#[doc = "Writer for register PUBLISH_FIELDLOST"]
pub type W = crate::W<u32, super::PUBLISH_FIELDLOST>;
#[doc = "Register PUBLISH_FIELDLOST `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_FIELDLOST {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event FIELDLOST will publish to."]
    #[inline(always)]
