#[doc = "Reader of register PUBLISH_READY"]
pub type R = crate::R<u32, super::PUBLISH_READY>;
#[doc = "Writer for register PUBLISH_READY"]
pub type W = crate::W<u32, super::PUBLISH_READY>;
#[doc = "Register PUBLISH_READY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_READY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event READY will publish to."]
    #[inline(always)]
