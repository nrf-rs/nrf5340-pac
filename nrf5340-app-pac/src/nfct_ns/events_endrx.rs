...
impl core::convert::From<crate::R<EVENTS_ENDRX_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ENDRX_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_ENDRX_R {
    type Target = crate::FieldReader<bool, EVENTS_ENDRX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
