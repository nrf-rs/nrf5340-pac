#[doc = "Reader of register EVENTS_COLLISION"]
pub type R = crate::R<u32, super::EVENTS_COLLISION>;
#[doc = "Writer for register EVENTS_COLLISION"]
pub type W = crate::W<u32, super::EVENTS_COLLISION>;
#[doc = "Register EVENTS_COLLISION `reset()`'s with value 0"]
impl crate::ResetValue for super::EVENTS_COLLISION {
    type Type = u32;
    #[inline(always)]
...
impl From<EVENTS_COLLISION_A> for bool {
    ...
    fn from(variant: EVENTS_COLLISION_A) -> Self {
        match variant {
            EVENTS_COLLISION_A::NOTGENERATED => false,
            EVENTS_COLLISION_A::GENERATED => true,
        }
    }
}
#[doc = "Reader of field `EVENTS_COLLISION`"]
pub type EVENTS_COLLISION_R = crate::R<bool, EVENTS_COLLISION_A>;
...
#[doc = "Write proxy for field `EVENTS_COLLISION`"]
