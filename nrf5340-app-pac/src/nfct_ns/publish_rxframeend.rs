#[doc = "Reader of register PUBLISH_RXFRAMEEND"]
pub type R = crate::R<u32, super::PUBLISH_RXFRAMEEND>;
#[doc = "Writer for register PUBLISH_RXFRAMEEND"]
pub type W = crate::W<u32, super::PUBLISH_RXFRAMEEND>;
#[doc = "Register PUBLISH_RXFRAMEEND `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXFRAMEEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXFRAMEEND will publish to."]
    #[inline(always)]
