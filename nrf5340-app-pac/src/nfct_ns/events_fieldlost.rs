...
impl core::convert::From<crate::R<EVENTS_FIELDLOST_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_FIELDLOST_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_FIELDLOST_R {
    type Target = crate::FieldReader<bool, EVENTS_FIELDLOST_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
