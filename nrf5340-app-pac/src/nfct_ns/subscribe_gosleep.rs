#[doc = "Reader of register SUBSCRIBE_GOSLEEP"]
pub type R = crate::R<u32, super::SUBSCRIBE_GOSLEEP>;
#[doc = "Writer for register SUBSCRIBE_GOSLEEP"]
pub type W = crate::W<u32, super::SUBSCRIBE_GOSLEEP>;
#[doc = "Register SUBSCRIBE_GOSLEEP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_GOSLEEP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task GOSLEEP will subscribe to"]
    #[inline(always)]
