#[doc = "Reader of register PUBLISH_SELECTED"]
pub type R = crate::R<u32, super::PUBLISH_SELECTED>;
#[doc = "Writer for register PUBLISH_SELECTED"]
pub type W = crate::W<u32, super::PUBLISH_SELECTED>;
#[doc = "Register PUBLISH_SELECTED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SELECTED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SELECTED will publish to."]
    #[inline(always)]
