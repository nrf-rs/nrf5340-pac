#[doc = "Reader of register PUBLISH_COLLISION"]
pub type R = crate::R<u32, super::PUBLISH_COLLISION>;
#[doc = "Writer for register PUBLISH_COLLISION"]
pub type W = crate::W<u32, super::PUBLISH_COLLISION>;
#[doc = "Register PUBLISH_COLLISION `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_COLLISION {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event COLLISION will publish to."]
    #[inline(always)]
