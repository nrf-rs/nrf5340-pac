#[doc = "Reader of register SUBSCRIBE_GOIDLE"]
pub type R = crate::R<u32, super::SUBSCRIBE_GOIDLE>;
#[doc = "Writer for register SUBSCRIBE_GOIDLE"]
pub type W = crate::W<u32, super::SUBSCRIBE_GOIDLE>;
#[doc = "Register SUBSCRIBE_GOIDLE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_GOIDLE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task GOIDLE will subscribe to"]
    #[inline(always)]
