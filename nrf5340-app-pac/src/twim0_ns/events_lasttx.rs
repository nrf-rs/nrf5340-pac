...
impl core::convert::From<crate::R<EVENTS_LASTTX_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_LASTTX_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_LASTTX_R {
    type Target = crate::FieldReader<bool, EVENTS_LASTTX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
