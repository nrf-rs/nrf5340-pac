#[doc = "Reader of register PUBLISH_SUSPENDED"]
pub type R = crate::R<u32, super::PUBLISH_SUSPENDED>;
#[doc = "Writer for register PUBLISH_SUSPENDED"]
pub type W = crate::W<u32, super::PUBLISH_SUSPENDED>;
#[doc = "Register PUBLISH_SUSPENDED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_SUSPENDED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event SUSPENDED will publish to."]
    #[inline(always)]
