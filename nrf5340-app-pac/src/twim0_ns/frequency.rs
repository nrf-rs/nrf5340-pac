...
impl From<FREQUENCY_A> for u32 {
    ...
    fn from(variant: FREQUENCY_A) -> Self {
        match variant {
            ...
            FREQUENCY_A::K400 => 104857600,
            FREQUENCY_A::K1000 => 267386880,
        }
    }
}
...
impl FREQUENCY_R {
    ...
    pub fn variant(&self) -> crate::Variant<u32, FREQUENCY_A> {
        ...
        match self.bits {
            ...
            267386880 => Val(FREQUENCY_A::K1000),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `K1000`"]
    #[inline(always)]
    pub fn is_k1000(&self) -> bool {
        *self == FREQUENCY_A::K1000
    }
}
...
impl<'a> FREQUENCY_W<'a> {
    ...
    #[doc = "1000 kbps"]
    #[inline(always)]
    pub fn k1000(self) -> &'a mut W {
        self.variant(FREQUENCY_A::K1000)
    }
