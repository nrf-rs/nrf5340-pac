...
#[doc = "Blocks debugger read/write access to all CPU registers and memory mapped addresses Using any value not listed below will yield unexpected results.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bits 0:31 - Blocks debugger read/write access to all CPU registers and memory mapped addresses Using any value not listed below will yield unexpected results."]
    #[inline(always)]
