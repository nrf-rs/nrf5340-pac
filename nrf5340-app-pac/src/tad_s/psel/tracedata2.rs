...
pub struct R(crate::R<TRACEDATA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRACEDATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TRACEDATA2_SPEC>> for R {
    fn from(reader: crate::R<TRACEDATA2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRACEDATA2` writer"]
pub struct W(crate::W<TRACEDATA2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRACEDATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TRACEDATA2_SPEC>> for W {
    fn from(writer: crate::W<TRACEDATA2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Pin number\n\nValue on reset: 31"]
...
impl PIN_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PIN_A> {
        use crate::Variant::*;
        match self.bits {
            9 => Val(PIN_A::TRACEDATA2),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `TRACEDATA2`"]
    #[inline(always)]
    pub fn is_tracedata2(&self) -> bool {
        **self == PIN_A::TRACEDATA2
    }
}
...
impl<'a> PIN_W<'a> {
    ...
    #[doc = "TRACEDATA2 pin"]
    #[inline(always)]
    pub fn tracedata2(self) -> &'a mut W {
        self.variant(PIN_A::TRACEDATA2)
    }
...
pub struct TRACEDATA2_SPEC;
impl crate::RegisterSpec for TRACEDATA2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tracedata2::R](R) reader structure"]
impl crate::Readable for TRACEDATA2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tracedata2::W](W) writer structure"]
impl crate::Writable for TRACEDATA2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TRACEDATA2 to value 0xffff_ffff"]
impl crate::Resettable for TRACEDATA2_SPEC {
    #[inline(always)]
