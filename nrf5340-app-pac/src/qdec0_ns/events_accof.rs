...
impl core::convert::From<crate::R<EVENTS_ACCOF_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ACCOF_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_ACCOF_R {
    type Target = crate::FieldReader<bool, EVENTS_ACCOF_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
