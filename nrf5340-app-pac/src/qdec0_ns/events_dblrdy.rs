...
impl core::convert::From<crate::R<EVENTS_DBLRDY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_DBLRDY_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_DBLRDY_R {
    type Target = crate::FieldReader<bool, EVENTS_DBLRDY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
