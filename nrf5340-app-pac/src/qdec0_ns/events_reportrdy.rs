...
impl core::convert::From<crate::R<EVENTS_REPORTRDY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_REPORTRDY_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_REPORTRDY_R {
    type Target = crate::FieldReader<bool, EVENTS_REPORTRDY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
