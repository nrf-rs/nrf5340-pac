...
impl core::convert::From<crate::R<EVENTS_KEYSLOT_ERROR_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_KEYSLOT_ERROR_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_KEYSLOT_ERROR_R {
    type Target = crate::FieldReader<bool, EVENTS_KEYSLOT_ERROR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
