#[doc = "Reader of register SUBSCRIBE_CLR[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_CLR>;
#[doc = "Writer for register SUBSCRIBE_CLR[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_CLR>;
#[doc = "Register SUBSCRIBE_CLR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CLR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CLR\\[n\\] will subscribe to"]
    #[inline(always)]
