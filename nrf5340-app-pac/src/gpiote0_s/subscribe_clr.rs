...
pub struct R(crate::R<SUBSCRIBE_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SUBSCRIBE_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<SUBSCRIBE_CLR_SPEC>> for R {
    fn from(reader: crate::R<SUBSCRIBE_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SUBSCRIBE_CLR[%s]` writer"]
pub struct W(crate::W<SUBSCRIBE_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SUBSCRIBE_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<SUBSCRIBE_CLR_SPEC>> for W {
    fn from(writer: crate::W<SUBSCRIBE_CLR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CHIDX` reader - DPPI channel that task CLR\\[n\\]
will subscribe to"]
...
#[doc = "Field `CHIDX` writer - DPPI channel that task CLR\\[n\\]
will subscribe to"]
...
pub struct SUBSCRIBE_CLR_SPEC;
impl crate::RegisterSpec for SUBSCRIBE_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [subscribe_clr::R](R) reader structure"]
impl crate::Readable for SUBSCRIBE_CLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [subscribe_clr::W](W) writer structure"]
impl crate::Writable for SUBSCRIBE_CLR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SUBSCRIBE_CLR[%s]
to value 0"]
impl crate::Resettable for SUBSCRIBE_CLR_SPEC {
    #[inline(always)]
