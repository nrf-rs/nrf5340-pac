...
impl core::convert::From<crate::R<EVENTS_PORT_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_PORT_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_PORT_R {
    type Target = crate::FieldReader<bool, EVENTS_PORT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
