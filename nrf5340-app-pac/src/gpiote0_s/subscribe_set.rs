#[doc = "Reader of register SUBSCRIBE_SET[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_SET>;
#[doc = "Writer for register SUBSCRIBE_SET[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_SET>;
#[doc = "Register SUBSCRIBE_SET[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SET {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SET\\[n\\] will subscribe to"]
    #[inline(always)]
