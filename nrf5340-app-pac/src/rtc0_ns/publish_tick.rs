#[doc = "Reader of register PUBLISH_TICK"]
pub type R = crate::R<u32, super::PUBLISH_TICK>;
#[doc = "Writer for register PUBLISH_TICK"]
pub type W = crate::W<u32, super::PUBLISH_TICK>;
#[doc = "Register PUBLISH_TICK `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TICK {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TICK will publish to."]
    #[inline(always)]
