#[doc = "Reader of register PUBLISH_OVRFLW"]
pub type R = crate::R<u32, super::PUBLISH_OVRFLW>;
#[doc = "Writer for register PUBLISH_OVRFLW"]
pub type W = crate::W<u32, super::PUBLISH_OVRFLW>;
#[doc = "Register PUBLISH_OVRFLW `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_OVRFLW {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event OVRFLW will publish to."]
    #[inline(always)]
