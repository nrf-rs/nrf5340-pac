#[doc = "Reader of register SUBSCRIBE_CAPTURE[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_CAPTURE>;
#[doc = "Writer for register SUBSCRIBE_CAPTURE[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_CAPTURE>;
#[doc = "Register SUBSCRIBE_CAPTURE[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CAPTURE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CAPTURE\\[n\\] will subscribe to"]
    #[inline(always)]
