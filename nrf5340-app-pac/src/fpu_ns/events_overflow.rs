...
impl core::convert::From<crate::R<EVENTS_OVERFLOW_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_OVERFLOW_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_OVERFLOW_R {
    type Target = crate::FieldReader<bool, EVENTS_OVERFLOW_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
