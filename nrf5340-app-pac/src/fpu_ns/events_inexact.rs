...
pub struct R(crate::R<EVENTS_INEXACT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EVENTS_INEXACT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<EVENTS_INEXACT_SPEC>> for R {
    fn from(reader: crate::R<EVENTS_INEXACT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EVENTS_INEXACT` writer"]
pub struct W(crate::W<EVENTS_INEXACT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EVENTS_INEXACT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<EVENTS_INEXACT_SPEC>> for W {
    fn from(writer: crate::W<EVENTS_INEXACT_SPEC>) -> Self {
        W(writer)
    }
}
...
impl core::ops::Deref for EVENTS_INEXACT_R {
    type Target = crate::FieldReader<bool, EVENTS_INEXACT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
#[doc = "An FPUIXC exception triggered by an inexact floating-point operation has occurred in the FPU\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [events_inexact](index.html) module"]
pub struct EVENTS_INEXACT_SPEC;
impl crate::RegisterSpec for EVENTS_INEXACT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [events_inexact::R](R) reader structure"]
impl crate::Readable for EVENTS_INEXACT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [events_inexact::W](W) writer structure"]
impl crate::Writable for EVENTS_INEXACT_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EVENTS_INEXACT to value 0"]
impl crate::Resettable for EVENTS_INEXACT_SPEC {
    #[inline(always)]
