#[doc = "Reader of register PUBLISH_TRIGGERED[%s]"]
pub type R = crate::R<u32, super::PUBLISH_TRIGGERED>;
#[doc = "Writer for register PUBLISH_TRIGGERED[%s]"]
pub type W = crate::W<u32, super::PUBLISH_TRIGGERED>;
#[doc = "Register PUBLISH_TRIGGERED[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TRIGGERED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TRIGGERED\\[n\\] will publish to."]
    #[inline(always)]
