#[doc = "Reader of register SUBSCRIBE_TRIGGER[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_TRIGGER>;
#[doc = "Writer for register SUBSCRIBE_TRIGGER[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_TRIGGER>;
#[doc = "Register SUBSCRIBE_TRIGGER[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_TRIGGER {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task TRIGGER\\[n\\] will subscribe to"]
    #[inline(always)]
