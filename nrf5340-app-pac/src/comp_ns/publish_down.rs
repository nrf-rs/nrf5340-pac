#[doc = "Reader of register PUBLISH_DOWN"]
pub type R = crate::R<u32, super::PUBLISH_DOWN>;
#[doc = "Writer for register PUBLISH_DOWN"]
pub type W = crate::W<u32, super::PUBLISH_DOWN>;
#[doc = "Register PUBLISH_DOWN `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DOWN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DOWN will publish to."]
    #[inline(always)]
