...
pub struct RegisterBlock {
    ...
    pub tasks_send: [crate::Reg<tasks_send::TASKS_SEND_SPEC>; 16],
    _reserved1: [u8; 64usize],
    #[doc = "0x80 - Description collection: Subscribe configuration for task SEND\\[n\\]"]
    pub subscribe_send: [crate::Reg<subscribe_send::SUBSCRIBE_SEND_SPEC>; 16],
    ...
    pub events_receive: [crate::Reg<events_receive::EVENTS_RECEIVE_SPEC>; 16],
    _reserved3: [u8; 64usize],
    #[doc = "0x180 - Description collection: Publish configuration for event RECEIVE\\[n\\]"]
    pub publish_receive: [crate::Reg<publish_receive::PUBLISH_RECEIVE_SPEC>; 16],
