#[doc = "Reader of register SUBSCRIBE_COUNT"]
pub type R = crate::R<u32, super::SUBSCRIBE_COUNT>;
#[doc = "Writer for register SUBSCRIBE_COUNT"]
pub type W = crate::W<u32, super::SUBSCRIBE_COUNT>;
#[doc = "Register SUBSCRIBE_COUNT `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_COUNT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task COUNT will subscribe to"]
    #[inline(always)]
