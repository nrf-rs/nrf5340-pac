#[doc = "Reader of register SUBSCRIBE_CLEAR"]
pub type R = crate::R<u32, super::SUBSCRIBE_CLEAR>;
#[doc = "Writer for register SUBSCRIBE_CLEAR"]
pub type W = crate::W<u32, super::SUBSCRIBE_CLEAR>;
#[doc = "Register SUBSCRIBE_CLEAR `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CLEAR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CLEAR will subscribe to"]
    #[inline(always)]
