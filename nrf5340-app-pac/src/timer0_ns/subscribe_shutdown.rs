#[doc = "Reader of register SUBSCRIBE_SHUTDOWN"]
pub type R = crate::R<u32, super::SUBSCRIBE_SHUTDOWN>;
#[doc = "Writer for register SUBSCRIBE_SHUTDOWN"]
pub type W = crate::W<u32, super::SUBSCRIBE_SHUTDOWN>;
#[doc = "Register SUBSCRIBE_SHUTDOWN `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SHUTDOWN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SHUTDOWN will subscribe to"]
    #[inline(always)]
