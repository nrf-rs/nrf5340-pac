...
impl core::convert::From<crate::R<SUBSCRIBE_CAPTURE_SPEC>> for R {
...
impl core::convert::From<crate::W<SUBSCRIBE_CAPTURE_SPEC>> for W {
    fn from(writer: crate::W<SUBSCRIBE_CAPTURE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CHIDX` reader - DPPI channel that task CAPTURE\\[n\\]
will subscribe to"]
...
#[doc = "Field `CHIDX` writer - DPPI channel that task CAPTURE\\[n\\]
will subscribe to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that task CAPTURE\\[n\\]
will subscribe to"]
    #[inline(always)]
