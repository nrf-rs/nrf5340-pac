...
impl core::convert::From<crate::R<EVENTS_TXDRDY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_TXDRDY_SPEC>> for W {
...
pub struct EVENTS_TXDRDY_R(crate::FieldReader<bool, EVENTS_TXDRDY_A>);
impl EVENTS_TXDRDY_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_TXDRDY_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_TXDRDY_R {
    type Target = crate::FieldReader<bool, EVENTS_TXDRDY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
