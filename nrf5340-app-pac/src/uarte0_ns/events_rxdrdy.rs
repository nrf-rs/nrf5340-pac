...
impl core::convert::From<crate::R<EVENTS_RXDRDY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_RXDRDY_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_RXDRDY_R {
    type Target = crate::FieldReader<bool, EVENTS_RXDRDY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
