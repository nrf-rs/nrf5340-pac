#[doc = "Reader of register PUBLISH_TXDRDY"]
pub type R = crate::R<u32, super::PUBLISH_TXDRDY>;
#[doc = "Writer for register PUBLISH_TXDRDY"]
pub type W = crate::W<u32, super::PUBLISH_TXDRDY>;
#[doc = "Register PUBLISH_TXDRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXDRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXDRDY will publish to."]
    #[inline(always)]
