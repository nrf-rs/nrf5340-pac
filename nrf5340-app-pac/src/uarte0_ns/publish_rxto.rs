#[doc = "Reader of register PUBLISH_RXTO"]
pub type R = crate::R<u32, super::PUBLISH_RXTO>;
#[doc = "Writer for register PUBLISH_RXTO"]
pub type W = crate::W<u32, super::PUBLISH_RXTO>;
#[doc = "Register PUBLISH_RXTO `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXTO {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXTO will publish to."]
    #[inline(always)]
