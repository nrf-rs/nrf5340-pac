#[doc = "Reader of register PUBLISH_ENDTX"]
pub type R = crate::R<u32, super::PUBLISH_ENDTX>;
#[doc = "Writer for register PUBLISH_ENDTX"]
pub type W = crate::W<u32, super::PUBLISH_ENDTX>;
#[doc = "Register PUBLISH_ENDTX `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDTX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDTX will publish to."]
    #[inline(always)]
