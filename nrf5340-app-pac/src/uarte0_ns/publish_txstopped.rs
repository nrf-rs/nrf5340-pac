#[doc = "Reader of register PUBLISH_TXSTOPPED"]
pub type R = crate::R<u32, super::PUBLISH_TXSTOPPED>;
#[doc = "Writer for register PUBLISH_TXSTOPPED"]
pub type W = crate::W<u32, super::PUBLISH_TXSTOPPED>;
#[doc = "Register PUBLISH_TXSTOPPED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXSTOPPED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXSTOPPED will publish to."]
    #[inline(always)]
