#[doc = "Reader of register PUBLISH_RXSTARTED"]
pub type R = crate::R<u32, super::PUBLISH_RXSTARTED>;
#[doc = "Writer for register PUBLISH_RXSTARTED"]
pub type W = crate::W<u32, super::PUBLISH_RXSTARTED>;
#[doc = "Register PUBLISH_RXSTARTED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXSTARTED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXSTARTED will publish to."]
    #[inline(always)]
