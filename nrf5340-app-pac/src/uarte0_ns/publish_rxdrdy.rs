#[doc = "Reader of register PUBLISH_RXDRDY"]
pub type R = crate::R<u32, super::PUBLISH_RXDRDY>;
#[doc = "Writer for register PUBLISH_RXDRDY"]
pub type W = crate::W<u32, super::PUBLISH_RXDRDY>;
#[doc = "Register PUBLISH_RXDRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXDRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXDRDY will publish to."]
    #[inline(always)]
