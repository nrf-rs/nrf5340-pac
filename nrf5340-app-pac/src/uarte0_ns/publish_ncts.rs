#[doc = "Reader of register PUBLISH_NCTS"]
pub type R = crate::R<u32, super::PUBLISH_NCTS>;
#[doc = "Writer for register PUBLISH_NCTS"]
pub type W = crate::W<u32, super::PUBLISH_NCTS>;
#[doc = "Register PUBLISH_NCTS `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_NCTS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event NCTS will publish to."]
    #[inline(always)]
