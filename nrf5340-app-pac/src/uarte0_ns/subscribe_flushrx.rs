#[doc = "Reader of register SUBSCRIBE_FLUSHRX"]
pub type R = crate::R<u32, super::SUBSCRIBE_FLUSHRX>;
#[doc = "Writer for register SUBSCRIBE_FLUSHRX"]
pub type W = crate::W<u32, super::SUBSCRIBE_FLUSHRX>;
#[doc = "Register SUBSCRIBE_FLUSHRX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_FLUSHRX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task FLUSHRX will subscribe to"]
    #[inline(always)]
