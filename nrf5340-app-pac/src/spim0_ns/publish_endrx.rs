#[doc = "Reader of register PUBLISH_ENDRX"]
pub type R = crate::R<u32, super::PUBLISH_ENDRX>;
#[doc = "Writer for register PUBLISH_ENDRX"]
pub type W = crate::W<u32, super::PUBLISH_ENDRX>;
#[doc = "Register PUBLISH_ENDRX `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDRX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDRX will publish to."]
    #[inline(always)]
