#[doc = "Reader of register PUBLISH_DONE"]
pub type R = crate::R<u32, super::PUBLISH_DONE>;
#[doc = "Writer for register PUBLISH_DONE"]
pub type W = crate::W<u32, super::PUBLISH_DONE>;
#[doc = "Register PUBLISH_DONE `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DONE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DONE will publish to."]
    #[inline(always)]
