#[doc = "Reader of register PUBLISH_RESULTDONE"]
pub type R = crate::R<u32, super::PUBLISH_RESULTDONE>;
#[doc = "Writer for register PUBLISH_RESULTDONE"]
pub type W = crate::W<u32, super::PUBLISH_RESULTDONE>;
#[doc = "Register PUBLISH_RESULTDONE `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RESULTDONE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RESULTDONE will publish to."]
    #[inline(always)]
