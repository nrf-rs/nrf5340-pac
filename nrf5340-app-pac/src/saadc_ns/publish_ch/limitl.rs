...
#[doc = "Field `CHIDX` reader - DPPI channel that event CH\\[n\\].LIMITL will publish to."]
...
#[doc = "Field `CHIDX` writer - DPPI channel that event CH\\[n\\].LIMITL will publish to."]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that event CH\\[n\\].LIMITL will publish to."]
    #[inline(always)]
