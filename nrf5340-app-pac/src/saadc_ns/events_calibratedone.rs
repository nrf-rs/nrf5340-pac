...
impl core::convert::From<crate::R<EVENTS_CALIBRATEDONE_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_CALIBRATEDONE_SPEC>> for W {
...
pub struct EVENTS_CALIBRATEDONE_R(crate::FieldReader<bool, EVENTS_CALIBRATEDONE_A>);
...
impl core::ops::Deref for EVENTS_CALIBRATEDONE_R {
    type Target = crate::FieldReader<bool, EVENTS_CALIBRATEDONE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
