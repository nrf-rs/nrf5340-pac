#[doc = "Reader of register PROFILINGENABLE"]
pub type R = crate::R<u32, super::PROFILINGENABLE>;
#[doc = "Writer for register PROFILINGENABLE"]
pub type W = crate::W<u32, super::PROFILINGENABLE>;
#[doc = "Register PROFILINGENABLE `reset()`'s with value 0"]
impl crate::ResetValue for super::PROFILINGENABLE {
    type Type = u32;
    #[inline(always)]
