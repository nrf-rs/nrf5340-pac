#[doc = "Reader of register PUBLISH_USBPWRRDY"]
pub type R = crate::R<u32, super::PUBLISH_USBPWRRDY>;
#[doc = "Writer for register PUBLISH_USBPWRRDY"]
pub type W = crate::W<u32, super::PUBLISH_USBPWRRDY>;
#[doc = "Register PUBLISH_USBPWRRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_USBPWRRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event USBPWRRDY will publish to."]
    #[inline(always)]
