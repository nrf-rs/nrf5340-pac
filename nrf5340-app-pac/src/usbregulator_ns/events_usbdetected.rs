...
impl core::convert::From<crate::R<EVENTS_USBDETECTED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_USBDETECTED_SPEC>> for W {
...
pub struct EVENTS_USBDETECTED_R(crate::FieldReader<bool, EVENTS_USBDETECTED_A>);
impl EVENTS_USBDETECTED_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_USBDETECTED_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_USBDETECTED_R {
    type Target = crate::FieldReader<bool, EVENTS_USBDETECTED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
