#[doc = "Reader of register PUBLISH_RESOLVED"]
pub type R = crate::R<u32, super::PUBLISH_RESOLVED>;
#[doc = "Writer for register PUBLISH_RESOLVED"]
pub type W = crate::W<u32, super::PUBLISH_RESOLVED>;
#[doc = "Register PUBLISH_RESOLVED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RESOLVED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RESOLVED will publish to."]
    #[inline(always)]
