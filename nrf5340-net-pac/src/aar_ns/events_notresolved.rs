...
impl core::convert::From<crate::R<EVENTS_NOTRESOLVED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_NOTRESOLVED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_NOTRESOLVED_R {
    type Target = crate::FieldReader<bool, EVENTS_NOTRESOLVED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
