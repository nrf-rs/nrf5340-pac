#[doc = "Reader of register SUBSCRIBE_START"]
pub type R = crate::R<u32, super::SUBSCRIBE_START>;
#[doc = "Writer for register SUBSCRIBE_START"]
pub type W = crate::W<u32, super::SUBSCRIBE_START>;
#[doc = "Register SUBSCRIBE_START `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_START {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task START will subscribe to"]
    #[inline(always)]
