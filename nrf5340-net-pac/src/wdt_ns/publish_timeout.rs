#[doc = "Reader of register PUBLISH_TIMEOUT"]
pub type R = crate::R<u32, super::PUBLISH_TIMEOUT>;
#[doc = "Writer for register PUBLISH_TIMEOUT"]
pub type W = crate::W<u32, super::PUBLISH_TIMEOUT>;
#[doc = "Register PUBLISH_TIMEOUT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TIMEOUT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TIMEOUT will publish to."]
    #[inline(always)]
