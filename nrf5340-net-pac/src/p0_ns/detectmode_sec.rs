#[doc = "Reader of register DETECTMODE_SEC"]
pub type R = crate::R<u32, super::DETECTMODE_SEC>;
#[doc = "Writer for register DETECTMODE_SEC"]
pub type W = crate::W<u32, super::DETECTMODE_SEC>;
#[doc = "Register DETECTMODE_SEC `reset()`'s with value 0"]
impl crate::ResetValue for super::DETECTMODE_SEC {
    type Type = u32;
    #[inline(always)]
