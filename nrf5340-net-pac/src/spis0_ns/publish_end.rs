#[doc = "Reader of register PUBLISH_END"]
pub type R = crate::R<u32, super::PUBLISH_END>;
#[doc = "Writer for register PUBLISH_END"]
pub type W = crate::W<u32, super::PUBLISH_END>;
#[doc = "Register PUBLISH_END `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_END {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event END will publish to."]
    #[inline(always)]
