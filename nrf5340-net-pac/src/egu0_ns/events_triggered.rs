...
impl core::convert::From<crate::R<EVENTS_TRIGGERED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_TRIGGERED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_TRIGGERED_R {
    type Target = crate::FieldReader<bool, EVENTS_TRIGGERED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
