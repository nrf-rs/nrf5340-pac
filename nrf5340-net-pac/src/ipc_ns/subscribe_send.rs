#[doc = "Reader of register SUBSCRIBE_SEND[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_SEND>;
#[doc = "Writer for register SUBSCRIBE_SEND[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_SEND>;
#[doc = "Register SUBSCRIBE_SEND[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_SEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task SEND\\[n\\] will subscribe to"]
    #[inline(always)]
