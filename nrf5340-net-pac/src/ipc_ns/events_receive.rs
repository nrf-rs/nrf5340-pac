...
impl core::convert::From<crate::R<EVENTS_RECEIVE_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_RECEIVE_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_RECEIVE_R {
    type Target = crate::FieldReader<bool, EVENTS_RECEIVE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
