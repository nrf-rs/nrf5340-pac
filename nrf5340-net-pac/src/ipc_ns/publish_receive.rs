...
impl core::convert::From<crate::R<PUBLISH_RECEIVE_SPEC>> for R {
...
impl core::convert::From<crate::W<PUBLISH_RECEIVE_SPEC>> for W {
    fn from(writer: crate::W<PUBLISH_RECEIVE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CHIDX` reader - DPPI channel that event RECEIVE\\[n\\]
will publish to."]
...
#[doc = "Field `CHIDX` writer - DPPI channel that event RECEIVE\\[n\\]
will publish to."]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that event RECEIVE\\[n\\]
will publish to."]
    #[inline(always)]
