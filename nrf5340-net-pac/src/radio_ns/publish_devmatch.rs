#[doc = "Reader of register PUBLISH_DEVMATCH"]
pub type R = crate::R<u32, super::PUBLISH_DEVMATCH>;
#[doc = "Writer for register PUBLISH_DEVMATCH"]
pub type W = crate::W<u32, super::PUBLISH_DEVMATCH>;
#[doc = "Register PUBLISH_DEVMATCH `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DEVMATCH {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DEVMATCH will publish to."]
    #[inline(always)]
