#[doc = "Reader of register PUBLISH_DEVMISS"]
pub type R = crate::R<u32, super::PUBLISH_DEVMISS>;
#[doc = "Writer for register PUBLISH_DEVMISS"]
pub type W = crate::W<u32, super::PUBLISH_DEVMISS>;
#[doc = "Register PUBLISH_DEVMISS `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DEVMISS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DEVMISS will publish to."]
    #[inline(always)]
