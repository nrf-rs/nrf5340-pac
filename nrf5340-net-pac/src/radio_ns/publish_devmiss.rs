...
pub struct R(crate::R<PUBLISH_DEVMISS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PUBLISH_DEVMISS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PUBLISH_DEVMISS_SPEC>> for R {
    fn from(reader: crate::R<PUBLISH_DEVMISS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PUBLISH_DEVMISS` writer"]
pub struct W(crate::W<PUBLISH_DEVMISS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PUBLISH_DEVMISS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<PUBLISH_DEVMISS_SPEC>> for W {
    fn from(writer: crate::W<PUBLISH_DEVMISS_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Publish configuration for event DEVMISS\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [publish_devmiss](index.html) module"]
pub struct PUBLISH_DEVMISS_SPEC;
impl crate::RegisterSpec for PUBLISH_DEVMISS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [publish_devmiss::R](R) reader structure"]
impl crate::Readable for PUBLISH_DEVMISS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [publish_devmiss::W](W) writer structure"]
impl crate::Writable for PUBLISH_DEVMISS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PUBLISH_DEVMISS to value 0"]
impl crate::Resettable for PUBLISH_DEVMISS_SPEC {
    #[inline(always)]
