#[doc = "Reader of register PUBLISH_CCASTOPPED"]
pub type R = crate::R<u32, super::PUBLISH_CCASTOPPED>;
#[doc = "Writer for register PUBLISH_CCASTOPPED"]
pub type W = crate::W<u32, super::PUBLISH_CCASTOPPED>;
#[doc = "Register PUBLISH_CCASTOPPED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CCASTOPPED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CCASTOPPED will publish to."]
    #[inline(always)]
