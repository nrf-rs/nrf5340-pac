#[doc = "Reader of register PUBLISH_CCAIDLE"]
pub type R = crate::R<u32, super::PUBLISH_CCAIDLE>;
#[doc = "Writer for register PUBLISH_CCAIDLE"]
pub type W = crate::W<u32, super::PUBLISH_CCAIDLE>;
#[doc = "Register PUBLISH_CCAIDLE `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CCAIDLE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CCAIDLE will publish to."]
    #[inline(always)]
