...
impl core::convert::From<crate::R<EVENTS_PAYLOAD_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_PAYLOAD_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_PAYLOAD_R {
    type Target = crate::FieldReader<bool, EVENTS_PAYLOAD_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
