#[doc = "Reader of register PUBLISH_ADDRESS"]
pub type R = crate::R<u32, super::PUBLISH_ADDRESS>;
#[doc = "Writer for register PUBLISH_ADDRESS"]
pub type W = crate::W<u32, super::PUBLISH_ADDRESS>;
#[doc = "Register PUBLISH_ADDRESS `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ADDRESS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ADDRESS will publish to."]
    #[inline(always)]
