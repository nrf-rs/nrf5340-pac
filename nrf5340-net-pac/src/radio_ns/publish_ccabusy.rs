#[doc = "Reader of register PUBLISH_CCABUSY"]
pub type R = crate::R<u32, super::PUBLISH_CCABUSY>;
#[doc = "Writer for register PUBLISH_CCABUSY"]
pub type W = crate::W<u32, super::PUBLISH_CCABUSY>;
#[doc = "Register PUBLISH_CCABUSY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CCABUSY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CCABUSY will publish to."]
    #[inline(always)]
