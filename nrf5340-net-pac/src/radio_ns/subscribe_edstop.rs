#[doc = "Reader of register SUBSCRIBE_EDSTOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_EDSTOP>;
#[doc = "Writer for register SUBSCRIBE_EDSTOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_EDSTOP>;
#[doc = "Register SUBSCRIBE_EDSTOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_EDSTOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task EDSTOP will subscribe to"]
    #[inline(always)]
