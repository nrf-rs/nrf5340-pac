...
impl core::convert::From<crate::R<EVENTS_DISABLED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_DISABLED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_DISABLED_R {
    type Target = crate::FieldReader<bool, EVENTS_DISABLED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
