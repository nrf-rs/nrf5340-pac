#[doc = "Reader of register SUBSCRIBE_TXEN"]
pub type R = crate::R<u32, super::SUBSCRIBE_TXEN>;
#[doc = "Writer for register SUBSCRIBE_TXEN"]
pub type W = crate::W<u32, super::SUBSCRIBE_TXEN>;
#[doc = "Register SUBSCRIBE_TXEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_TXEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task TXEN will subscribe to"]
    #[inline(always)]
