...
impl core::convert::From<crate::R<EVENTS_CCASTOPPED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_CCASTOPPED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_CCASTOPPED_R {
    type Target = crate::FieldReader<bool, EVENTS_CCASTOPPED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
