#[doc = "Reader of register SUBSCRIBE_RSSISTOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_RSSISTOP>;
#[doc = "Writer for register SUBSCRIBE_RSSISTOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_RSSISTOP>;
#[doc = "Register SUBSCRIBE_RSSISTOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RSSISTOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RSSISTOP will subscribe to"]
    #[inline(always)]
