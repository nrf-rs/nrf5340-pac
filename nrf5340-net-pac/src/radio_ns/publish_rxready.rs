#[doc = "Reader of register PUBLISH_RXREADY"]
pub type R = crate::R<u32, super::PUBLISH_RXREADY>;
#[doc = "Writer for register PUBLISH_RXREADY"]
pub type W = crate::W<u32, super::PUBLISH_RXREADY>;
#[doc = "Register PUBLISH_RXREADY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RXREADY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RXREADY will publish to."]
    #[inline(always)]
