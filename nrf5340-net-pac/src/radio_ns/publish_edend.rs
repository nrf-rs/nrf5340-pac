#[doc = "Reader of register PUBLISH_EDEND"]
pub type R = crate::R<u32, super::PUBLISH_EDEND>;
#[doc = "Writer for register PUBLISH_EDEND"]
pub type W = crate::W<u32, super::PUBLISH_EDEND>;
#[doc = "Register PUBLISH_EDEND `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_EDEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event EDEND will publish to."]
    #[inline(always)]
