...
impl core::convert::From<crate::R<EVENTS_BCMATCH_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_BCMATCH_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_BCMATCH_R {
    type Target = crate::FieldReader<bool, EVENTS_BCMATCH_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
