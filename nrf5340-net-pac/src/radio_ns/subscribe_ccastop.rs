#[doc = "Reader of register SUBSCRIBE_CCASTOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_CCASTOP>;
#[doc = "Writer for register SUBSCRIBE_CCASTOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_CCASTOP>;
#[doc = "Register SUBSCRIBE_CCASTOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CCASTOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CCASTOP will subscribe to"]
    #[inline(always)]
