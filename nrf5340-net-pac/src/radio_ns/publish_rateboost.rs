#[doc = "Reader of register PUBLISH_RATEBOOST"]
pub type R = crate::R<u32, super::PUBLISH_RATEBOOST>;
#[doc = "Writer for register PUBLISH_RATEBOOST"]
pub type W = crate::W<u32, super::PUBLISH_RATEBOOST>;
#[doc = "Register PUBLISH_RATEBOOST `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RATEBOOST {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RATEBOOST will publish to."]
    #[inline(always)]
