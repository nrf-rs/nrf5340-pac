#[doc = "Reader of register PUBLISH_CTEPRESENT"]
pub type R = crate::R<u32, super::PUBLISH_CTEPRESENT>;
#[doc = "Writer for register PUBLISH_CTEPRESENT"]
pub type W = crate::W<u32, super::PUBLISH_CTEPRESENT>;
#[doc = "Register PUBLISH_CTEPRESENT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CTEPRESENT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CTEPRESENT will publish to."]
    #[inline(always)]
