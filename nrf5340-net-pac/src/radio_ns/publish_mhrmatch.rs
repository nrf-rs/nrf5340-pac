#[doc = "Reader of register PUBLISH_MHRMATCH"]
pub type R = crate::R<u32, super::PUBLISH_MHRMATCH>;
#[doc = "Writer for register PUBLISH_MHRMATCH"]
pub type W = crate::W<u32, super::PUBLISH_MHRMATCH>;
#[doc = "Register PUBLISH_MHRMATCH `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_MHRMATCH {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event MHRMATCH will publish to."]
    #[inline(always)]
