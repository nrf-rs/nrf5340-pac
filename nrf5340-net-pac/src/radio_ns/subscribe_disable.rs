#[doc = "Reader of register SUBSCRIBE_DISABLE"]
pub type R = crate::R<u32, super::SUBSCRIBE_DISABLE>;
#[doc = "Writer for register SUBSCRIBE_DISABLE"]
pub type W = crate::W<u32, super::SUBSCRIBE_DISABLE>;
#[doc = "Register SUBSCRIBE_DISABLE `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_DISABLE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task DISABLE will subscribe to"]
    #[inline(always)]
