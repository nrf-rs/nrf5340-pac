#[doc = "Reader of register PUBLISH_EDSTOPPED"]
pub type R = crate::R<u32, super::PUBLISH_EDSTOPPED>;
#[doc = "Writer for register PUBLISH_EDSTOPPED"]
pub type W = crate::W<u32, super::PUBLISH_EDSTOPPED>;
#[doc = "Register PUBLISH_EDSTOPPED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_EDSTOPPED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event EDSTOPPED will publish to."]
    #[inline(always)]
