...
pub struct R(crate::R<DFEGPIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFEGPIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<DFEGPIO_SPEC>> for R {
    fn from(reader: crate::R<DFEGPIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFEGPIO[%s]` writer"]
pub struct W(crate::W<DFEGPIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFEGPIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<DFEGPIO_SPEC>> for W {
    fn from(writer: crate::W<DFEGPIO_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Description collection: Pin select for DFE pin n\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfegpio](index.html) module"]
pub struct DFEGPIO_SPEC;
impl crate::RegisterSpec for DFEGPIO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfegpio::R](R) reader structure"]
impl crate::Readable for DFEGPIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfegpio::W](W) writer structure"]
impl crate::Writable for DFEGPIO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DFEGPIO[%s]
to value 0xffff_ffff"]
impl crate::Resettable for DFEGPIO_SPEC {
    #[inline(always)]
