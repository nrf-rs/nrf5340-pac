#[doc = "Reader of register DFEGPIO[%s]"]
pub type R = crate::R<u32, super::DFEGPIO>;
#[doc = "Writer for register DFEGPIO[%s]"]
pub type W = crate::W<u32, super::DFEGPIO>;
#[doc = "Register DFEGPIO[%s] `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::DFEGPIO {
    type Type = u32;
    #[inline(always)]
