#[doc = "Reader of register SUBSCRIBE_EDSTART"]
pub type R = crate::R<u32, super::SUBSCRIBE_EDSTART>;
#[doc = "Writer for register SUBSCRIBE_EDSTART"]
pub type W = crate::W<u32, super::SUBSCRIBE_EDSTART>;
#[doc = "Register SUBSCRIBE_EDSTART `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_EDSTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task EDSTART will subscribe to"]
    #[inline(always)]
