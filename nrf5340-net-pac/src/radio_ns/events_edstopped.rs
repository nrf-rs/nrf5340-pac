...
impl core::convert::From<crate::R<EVENTS_EDSTOPPED_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_EDSTOPPED_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_EDSTOPPED_R {
    type Target = crate::FieldReader<bool, EVENTS_EDSTOPPED_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
