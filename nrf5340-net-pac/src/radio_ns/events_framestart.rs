...
impl core::convert::From<crate::R<EVENTS_FRAMESTART_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_FRAMESTART_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_FRAMESTART_R {
    type Target = crate::FieldReader<bool, EVENTS_FRAMESTART_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
