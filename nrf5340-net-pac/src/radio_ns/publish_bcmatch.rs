#[doc = "Reader of register PUBLISH_BCMATCH"]
pub type R = crate::R<u32, super::PUBLISH_BCMATCH>;
#[doc = "Writer for register PUBLISH_BCMATCH"]
pub type W = crate::W<u32, super::PUBLISH_BCMATCH>;
#[doc = "Register PUBLISH_BCMATCH `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_BCMATCH {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event BCMATCH will publish to."]
    #[inline(always)]
