#[doc = "Reader of register PUBLISH_CRCERROR"]
pub type R = crate::R<u32, super::PUBLISH_CRCERROR>;
#[doc = "Writer for register PUBLISH_CRCERROR"]
pub type W = crate::W<u32, super::PUBLISH_CRCERROR>;
#[doc = "Register PUBLISH_CRCERROR `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CRCERROR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CRCERROR will publish to."]
    #[inline(always)]
