...
impl core::convert::From<crate::R<EVENTS_DEVMATCH_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_DEVMATCH_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_DEVMATCH_R {
    type Target = crate::FieldReader<bool, EVENTS_DEVMATCH_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
