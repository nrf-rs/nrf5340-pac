#[doc = "Reader of register PUBLISH_PHYEND"]
pub type R = crate::R<u32, super::PUBLISH_PHYEND>;
#[doc = "Writer for register PUBLISH_PHYEND"]
pub type W = crate::W<u32, super::PUBLISH_PHYEND>;
#[doc = "Register PUBLISH_PHYEND `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_PHYEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event PHYEND will publish to."]
    #[inline(always)]
