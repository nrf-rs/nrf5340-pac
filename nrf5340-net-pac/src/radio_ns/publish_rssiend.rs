#[doc = "Reader of register PUBLISH_RSSIEND"]
pub type R = crate::R<u32, super::PUBLISH_RSSIEND>;
#[doc = "Writer for register PUBLISH_RSSIEND"]
pub type W = crate::W<u32, super::PUBLISH_RSSIEND>;
#[doc = "Register PUBLISH_RSSIEND `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_RSSIEND {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event RSSIEND will publish to."]
    #[inline(always)]
