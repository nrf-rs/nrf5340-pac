...
impl core::convert::From<crate::R<EVENTS_PHYEND_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_PHYEND_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_PHYEND_R {
    type Target = crate::FieldReader<bool, EVENTS_PHYEND_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
