#[doc = "Reader of register SUBSCRIBE_BCSTART"]
pub type R = crate::R<u32, super::SUBSCRIBE_BCSTART>;
#[doc = "Writer for register SUBSCRIBE_BCSTART"]
pub type W = crate::W<u32, super::SUBSCRIBE_BCSTART>;
#[doc = "Register SUBSCRIBE_BCSTART `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_BCSTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task BCSTART will subscribe to"]
    #[inline(always)]
