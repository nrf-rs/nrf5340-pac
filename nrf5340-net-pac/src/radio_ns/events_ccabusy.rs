...
impl core::convert::From<crate::R<EVENTS_CCABUSY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_CCABUSY_SPEC>> for W {
...
pub struct EVENTS_CCABUSY_R(crate::FieldReader<bool, EVENTS_CCABUSY_A>);
...
impl core::ops::Deref for EVENTS_CCABUSY_R {
    type Target = crate::FieldReader<bool, EVENTS_CCABUSY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
