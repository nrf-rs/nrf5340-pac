#[doc = "Reader of register PUBLISH_TXREADY"]
pub type R = crate::R<u32, super::PUBLISH_TXREADY>;
#[doc = "Writer for register PUBLISH_TXREADY"]
pub type W = crate::W<u32, super::PUBLISH_TXREADY>;
#[doc = "Register PUBLISH_TXREADY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXREADY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXREADY will publish to."]
    #[inline(always)]
