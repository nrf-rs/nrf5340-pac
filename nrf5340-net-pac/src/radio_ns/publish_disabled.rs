#[doc = "Reader of register PUBLISH_DISABLED"]
pub type R = crate::R<u32, super::PUBLISH_DISABLED>;
#[doc = "Writer for register PUBLISH_DISABLED"]
pub type W = crate::W<u32, super::PUBLISH_DISABLED>;
#[doc = "Register PUBLISH_DISABLED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DISABLED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DISABLED will publish to."]
    #[inline(always)]
