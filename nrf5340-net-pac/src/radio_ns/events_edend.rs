...
impl core::convert::From<crate::R<EVENTS_EDEND_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_EDEND_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_EDEND_R {
    type Target = crate::FieldReader<bool, EVENTS_EDEND_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
