#[doc = "Reader of register SUBSCRIBE_RSSISTART"]
pub type R = crate::R<u32, super::SUBSCRIBE_RSSISTART>;
#[doc = "Writer for register SUBSCRIBE_RSSISTART"]
pub type W = crate::W<u32, super::SUBSCRIBE_RSSISTART>;
#[doc = "Register SUBSCRIBE_RSSISTART `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RSSISTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RSSISTART will subscribe to"]
    #[inline(always)]
