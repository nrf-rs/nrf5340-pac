...
impl core::convert::From<crate::R<EVENTS_CRCOK_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_CRCOK_SPEC>> for W {
...
pub struct EVENTS_CRCOK_R(crate::FieldReader<bool, EVENTS_CRCOK_A>);
impl EVENTS_CRCOK_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_CRCOK_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_CRCOK_R {
    type Target = crate::FieldReader<bool, EVENTS_CRCOK_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
