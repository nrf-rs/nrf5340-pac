#[doc = "Reader of register PUBLISH_PAYLOAD"]
pub type R = crate::R<u32, super::PUBLISH_PAYLOAD>;
#[doc = "Writer for register PUBLISH_PAYLOAD"]
pub type W = crate::W<u32, super::PUBLISH_PAYLOAD>;
#[doc = "Register PUBLISH_PAYLOAD `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_PAYLOAD {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event PAYLOAD will publish to."]
    #[inline(always)]
