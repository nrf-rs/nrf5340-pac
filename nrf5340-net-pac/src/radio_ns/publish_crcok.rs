#[doc = "Reader of register PUBLISH_CRCOK"]
pub type R = crate::R<u32, super::PUBLISH_CRCOK>;
#[doc = "Writer for register PUBLISH_CRCOK"]
pub type W = crate::W<u32, super::PUBLISH_CRCOK>;
#[doc = "Register PUBLISH_CRCOK `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CRCOK {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CRCOK will publish to."]
    #[inline(always)]
