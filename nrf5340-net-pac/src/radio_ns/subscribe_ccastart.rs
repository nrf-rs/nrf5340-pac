#[doc = "Reader of register SUBSCRIBE_CCASTART"]
pub type R = crate::R<u32, super::SUBSCRIBE_CCASTART>;
#[doc = "Writer for register SUBSCRIBE_CCASTART"]
pub type W = crate::W<u32, super::SUBSCRIBE_CCASTART>;
#[doc = "Register SUBSCRIBE_CCASTART `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CCASTART {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CCASTART will subscribe to"]
    #[inline(always)]
