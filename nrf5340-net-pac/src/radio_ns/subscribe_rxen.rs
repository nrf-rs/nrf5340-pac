#[doc = "Reader of register SUBSCRIBE_RXEN"]
pub type R = crate::R<u32, super::SUBSCRIBE_RXEN>;
#[doc = "Writer for register SUBSCRIBE_RXEN"]
pub type W = crate::W<u32, super::SUBSCRIBE_RXEN>;
#[doc = "Register SUBSCRIBE_RXEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_RXEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task RXEN will subscribe to"]
    #[inline(always)]
