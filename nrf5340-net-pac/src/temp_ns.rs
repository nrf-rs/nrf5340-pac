...
pub struct RegisterBlock {
    ...
    pub publish_datardy: PUBLISH_DATARDY,
...
#[doc = "Publish configuration for event DATARDY\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about avaliable fields see [publish_datardy](publish_datardy) module"]
pub type PUBLISH_DATARDY = crate::Reg<u32, _PUBLISH_DATARDY>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _PUBLISH_DATARDY;
#[doc = "`read()` method returns [publish_datardy::R](publish_datardy::R) reader structure"]
impl crate::Readable for PUBLISH_DATARDY {}
#[doc = "`write(|w| ..)` method takes [publish_datardy::W](publish_datardy::W) writer structure"]
impl crate::Writable for PUBLISH_DATARDY {}
#[doc = "Publish configuration for event DATARDY"]
