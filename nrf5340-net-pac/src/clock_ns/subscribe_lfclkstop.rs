#[doc = "Reader of register SUBSCRIBE_LFCLKSTOP"]
pub type R = crate::R<u32, super::SUBSCRIBE_LFCLKSTOP>;
#[doc = "Writer for register SUBSCRIBE_LFCLKSTOP"]
pub type W = crate::W<u32, super::SUBSCRIBE_LFCLKSTOP>;
#[doc = "Register SUBSCRIBE_LFCLKSTOP `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_LFCLKSTOP {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task LFCLKSTOP will subscribe to"]
    #[inline(always)]
