...
pub struct R(crate::R<HFCLKALWAYSRUN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFCLKALWAYSRUN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<HFCLKALWAYSRUN_SPEC>> for R {
    fn from(reader: crate::R<HFCLKALWAYSRUN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HFCLKALWAYSRUN` writer"]
pub struct W(crate::W<HFCLKALWAYSRUN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HFCLKALWAYSRUN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<HFCLKALWAYSRUN_SPEC>> for W {
    fn from(writer: crate::W<HFCLKALWAYSRUN_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Automatic or manual control of HFCLK128M/HFCLK64M\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfclkalwaysrun](index.html) module"]
pub struct HFCLKALWAYSRUN_SPEC;
impl crate::RegisterSpec for HFCLKALWAYSRUN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfclkalwaysrun::R](R) reader structure"]
impl crate::Readable for HFCLKALWAYSRUN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [hfclkalwaysrun::W](W) writer structure"]
impl crate::Writable for HFCLKALWAYSRUN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HFCLKALWAYSRUN to value 0"]
impl crate::Resettable for HFCLKALWAYSRUN_SPEC {
    #[inline(always)]
