#[doc = "Reader of register SUBSCRIBE_CAL"]
pub type R = crate::R<u32, super::SUBSCRIBE_CAL>;
#[doc = "Writer for register SUBSCRIBE_CAL"]
pub type W = crate::W<u32, super::SUBSCRIBE_CAL>;
#[doc = "Register SUBSCRIBE_CAL `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CAL {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CAL will subscribe to"]
    #[inline(always)]
