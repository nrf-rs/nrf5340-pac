#[doc = "Reader of register SUBSCRIBE_STARTRX"]
pub type R = crate::R<u32, super::SUBSCRIBE_STARTRX>;
#[doc = "Writer for register SUBSCRIBE_STARTRX"]
pub type W = crate::W<u32, super::SUBSCRIBE_STARTRX>;
#[doc = "Register SUBSCRIBE_STARTRX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STARTRX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STARTRX will subscribe to"]
    #[inline(always)]
