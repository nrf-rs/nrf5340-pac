#[doc = "Reader of register SUBSCRIBE_STOPTX"]
pub type R = crate::R<u32, super::SUBSCRIBE_STOPTX>;
#[doc = "Writer for register SUBSCRIBE_STOPTX"]
pub type W = crate::W<u32, super::SUBSCRIBE_STOPTX>;
#[doc = "Register SUBSCRIBE_STOPTX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STOPTX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STOPTX will subscribe to"]
    #[inline(always)]
