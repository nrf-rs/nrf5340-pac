#[doc = "Reader of register SUBSCRIBE_STOPRX"]
pub type R = crate::R<u32, super::SUBSCRIBE_STOPRX>;
#[doc = "Writer for register SUBSCRIBE_STOPRX"]
pub type W = crate::W<u32, super::SUBSCRIBE_STOPRX>;
#[doc = "Register SUBSCRIBE_STOPRX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STOPRX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STOPRX will subscribe to"]
    #[inline(always)]
