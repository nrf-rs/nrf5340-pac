#[doc = "Reader of register PUBLISH_CTS"]
pub type R = crate::R<u32, super::PUBLISH_CTS>;
#[doc = "Writer for register PUBLISH_CTS"]
pub type W = crate::W<u32, super::PUBLISH_CTS>;
#[doc = "Register PUBLISH_CTS `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_CTS {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event CTS will publish to."]
    #[inline(always)]
