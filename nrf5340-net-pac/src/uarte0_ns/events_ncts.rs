...
impl core::convert::From<crate::R<EVENTS_NCTS_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_NCTS_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_NCTS_R {
    type Target = crate::FieldReader<bool, EVENTS_NCTS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
