#[doc = "Reader of register PUBLISH_DATARDY"]
pub type R = crate::R<u32, super::PUBLISH_DATARDY>;
#[doc = "Writer for register PUBLISH_DATARDY"]
pub type W = crate::W<u32, super::PUBLISH_DATARDY>;
#[doc = "Register PUBLISH_DATARDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_DATARDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event DATARDY will publish to."]
    #[inline(always)]
