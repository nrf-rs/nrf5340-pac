...
impl core::convert::From<crate::R<T3_SPEC>> for R {
...
impl core::convert::From<crate::W<T3_SPEC>> for W {
    fn from(writer: crate::W<T3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `T3` reader - Endpoint of fourth piecewise linear function"]
...
#[doc = "Field `T3` writer - Endpoint of fourth piecewise linear function"]
pub struct T3_W<'a> {
    w: &'a mut W,
}
impl<'a> T3_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - Endpoint of fourth piecewise linear function"]
    #[inline(always)]
    pub fn t3(&self) -> T3_R {
...
#[doc = "`reset()` method sets T3 to value 0x26"]
