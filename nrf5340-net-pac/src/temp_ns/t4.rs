...
impl core::convert::From<crate::R<T4_SPEC>> for R {
...
impl core::convert::From<crate::W<T4_SPEC>> for W {
    fn from(writer: crate::W<T4_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `T4` reader - Endpoint of fifth piecewise linear function"]
...
#[doc = "Field `T4` writer - Endpoint of fifth piecewise linear function"]
pub struct T4_W<'a> {
    w: &'a mut W,
}
impl<'a> T4_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - Endpoint of fifth piecewise linear function"]
    #[inline(always)]
    pub fn t4(&self) -> T4_R {
...
#[doc = "`reset()` method sets T4 to value 0x3f"]
