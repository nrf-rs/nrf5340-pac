...
impl core::convert::From<crate::R<B5_SPEC>> for R {
...
impl core::convert::From<crate::W<B5_SPEC>> for W {
...
impl R {
    #[doc = "Bits 0:11 - y-intercept of sixth piecewise linear function"]
    #[inline(always)]
    pub fn b5(&self) -> B5_R {
        B5_R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - y-intercept of sixth piecewise linear function"]
...
#[doc = "`reset()` method sets B5 to value 0xf6"]
