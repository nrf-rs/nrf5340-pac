...
impl core::convert::From<crate::R<T0_SPEC>> for R {
...
impl core::convert::From<crate::W<T0_SPEC>> for W {
    fn from(writer: crate::W<T0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `T0` reader - Endpoint of first piecewise linear function"]
...
#[doc = "Field `T0` writer - Endpoint of first piecewise linear function"]
pub struct T0_W<'a> {
    w: &'a mut W,
}
impl<'a> T0_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - Endpoint of first piecewise linear function"]
    #[inline(always)]
    pub fn t0(&self) -> T0_R {
...
#[doc = "`reset()` method sets T0 to value 0xe1"]
