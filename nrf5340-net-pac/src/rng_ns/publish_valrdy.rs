#[doc = "Reader of register PUBLISH_VALRDY"]
pub type R = crate::R<u32, super::PUBLISH_VALRDY>;
#[doc = "Writer for register PUBLISH_VALRDY"]
pub type W = crate::W<u32, super::PUBLISH_VALRDY>;
#[doc = "Register PUBLISH_VALRDY `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_VALRDY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event VALRDY will publish to."]
    #[inline(always)]
