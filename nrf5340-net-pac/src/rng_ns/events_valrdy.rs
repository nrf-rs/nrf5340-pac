...
impl core::convert::From<crate::R<EVENTS_VALRDY_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_VALRDY_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_VALRDY_R {
    type Target = crate::FieldReader<bool, EVENTS_VALRDY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
