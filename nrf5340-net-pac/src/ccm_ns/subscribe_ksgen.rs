#[doc = "Reader of register SUBSCRIBE_KSGEN"]
pub type R = crate::R<u32, super::SUBSCRIBE_KSGEN>;
#[doc = "Writer for register SUBSCRIBE_KSGEN"]
pub type W = crate::W<u32, super::SUBSCRIBE_KSGEN>;
#[doc = "Register SUBSCRIBE_KSGEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_KSGEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task KSGEN will subscribe to"]
    #[inline(always)]
