#[doc = "Reader of register SUBSCRIBE_CRYPT"]
pub type R = crate::R<u32, super::SUBSCRIBE_CRYPT>;
#[doc = "Writer for register SUBSCRIBE_CRYPT"]
pub type W = crate::W<u32, super::SUBSCRIBE_CRYPT>;
#[doc = "Register SUBSCRIBE_CRYPT `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_CRYPT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task CRYPT will subscribe to"]
    #[inline(always)]
