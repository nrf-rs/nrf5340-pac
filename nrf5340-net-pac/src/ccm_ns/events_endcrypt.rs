...
impl core::convert::From<crate::R<EVENTS_ENDCRYPT_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ENDCRYPT_SPEC>> for W {
...
pub struct EVENTS_ENDCRYPT_R(crate::FieldReader<bool, EVENTS_ENDCRYPT_A>);
impl EVENTS_ENDCRYPT_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_ENDCRYPT_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for EVENTS_ENDCRYPT_R {
    type Target = crate::FieldReader<bool, EVENTS_ENDCRYPT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
