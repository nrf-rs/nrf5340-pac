#[doc = "Reader of register PUBLISH_ENDCRYPT"]
pub type R = crate::R<u32, super::PUBLISH_ENDCRYPT>;
#[doc = "Writer for register PUBLISH_ENDCRYPT"]
pub type W = crate::W<u32, super::PUBLISH_ENDCRYPT>;
#[doc = "Register PUBLISH_ENDCRYPT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDCRYPT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDCRYPT will publish to."]
    #[inline(always)]
