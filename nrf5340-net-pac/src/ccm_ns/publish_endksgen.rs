#[doc = "Reader of register PUBLISH_ENDKSGEN"]
pub type R = crate::R<u32, super::PUBLISH_ENDKSGEN>;
#[doc = "Writer for register PUBLISH_ENDKSGEN"]
pub type W = crate::W<u32, super::PUBLISH_ENDKSGEN>;
#[doc = "Register PUBLISH_ENDKSGEN `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDKSGEN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDKSGEN will publish to."]
    #[inline(always)]
