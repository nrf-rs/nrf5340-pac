...
#[doc = "Register APPROTECT `reset()`'s with value 0"]
...
#[doc = "Blocks debugger read/write access to all CPU registers and memory mapped addresses Any value except for the enumerations will yield unexpected results.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bits 0:31 - Blocks debugger read/write access to all CPU registers and memory mapped addresses Any value except for the enumerations will yield unexpected results."]
    #[inline(always)]
