#[doc = "Reader of register ERASEPROTECT"]
pub type R = crate::R<u32, super::ERASEPROTECT>;
#[doc = "Writer for register ERASEPROTECT"]
pub type W = crate::W<u32, super::ERASEPROTECT>;
#[doc = "Register ERASEPROTECT `reset()`'s with value 0"]
impl crate::ResetValue for super::ERASEPROTECT {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Blocks NVMC ERASEALL and CTRLAP ERASEALL functionality. Any value except for the enumerations will yield unexpected results.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bits 0:31 - Blocks NVMC ERASEALL and CTRLAP ERASEALL functionality. Any value except for the enumerations will yield unexpected results."]
    #[inline(always)]
