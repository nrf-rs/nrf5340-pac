#[doc = "Reader of register PUBLISH_ERRORECB"]
pub type R = crate::R<u32, super::PUBLISH_ERRORECB>;
#[doc = "Writer for register PUBLISH_ERRORECB"]
pub type W = crate::W<u32, super::PUBLISH_ERRORECB>;
#[doc = "Register PUBLISH_ERRORECB `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ERRORECB {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ERRORECB will publish to."]
    #[inline(always)]
