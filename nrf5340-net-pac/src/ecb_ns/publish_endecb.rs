#[doc = "Reader of register PUBLISH_ENDECB"]
pub type R = crate::R<u32, super::PUBLISH_ENDECB>;
#[doc = "Writer for register PUBLISH_ENDECB"]
pub type W = crate::W<u32, super::PUBLISH_ENDECB>;
#[doc = "Register PUBLISH_ENDECB `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ENDECB {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ENDECB will publish to."]
    #[inline(always)]
