#[doc = "Reader of register SUBSCRIBE_STOPECB"]
pub type R = crate::R<u32, super::SUBSCRIBE_STOPECB>;
#[doc = "Writer for register SUBSCRIBE_STOPECB"]
pub type W = crate::W<u32, super::SUBSCRIBE_STOPECB>;
#[doc = "Register SUBSCRIBE_STOPECB `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STOPECB {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STOPECB will subscribe to"]
    #[inline(always)]
