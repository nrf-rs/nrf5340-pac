...
impl core::convert::From<crate::R<EVENTS_ENDECB_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ENDECB_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_ENDECB_R {
    type Target = crate::FieldReader<bool, EVENTS_ENDECB_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
