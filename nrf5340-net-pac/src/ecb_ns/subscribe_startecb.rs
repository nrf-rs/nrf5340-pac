#[doc = "Reader of register SUBSCRIBE_STARTECB"]
pub type R = crate::R<u32, super::SUBSCRIBE_STARTECB>;
#[doc = "Writer for register SUBSCRIBE_STARTECB"]
pub type W = crate::W<u32, super::SUBSCRIBE_STARTECB>;
#[doc = "Register SUBSCRIBE_STARTECB `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STARTECB {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STARTECB will subscribe to"]
    #[inline(always)]
