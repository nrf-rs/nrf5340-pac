...
impl core::convert::From<crate::R<EVENTS_ERRORECB_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_ERRORECB_SPEC>> for W {
...
impl core::ops::Deref for EVENTS_ERRORECB_R {
    type Target = crate::FieldReader<bool, EVENTS_ERRORECB_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
