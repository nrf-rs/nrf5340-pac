#[doc = "Reader of register PUBLISH_ERROR"]
pub type R = crate::R<u32, super::PUBLISH_ERROR>;
#[doc = "Writer for register PUBLISH_ERROR"]
pub type W = crate::W<u32, super::PUBLISH_ERROR>;
#[doc = "Register PUBLISH_ERROR `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_ERROR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event ERROR will publish to."]
    #[inline(always)]
