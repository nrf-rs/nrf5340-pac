#[doc = "Reader of register SUBSCRIBE_PREPARERX"]
pub type R = crate::R<u32, super::SUBSCRIBE_PREPARERX>;
#[doc = "Writer for register SUBSCRIBE_PREPARERX"]
pub type W = crate::W<u32, super::SUBSCRIBE_PREPARERX>;
#[doc = "Register SUBSCRIBE_PREPARERX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_PREPARERX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task PREPARERX will subscribe to"]
    #[inline(always)]
