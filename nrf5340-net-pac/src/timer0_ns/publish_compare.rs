#[doc = "Reader of register PUBLISH_COMPARE[%s]"]
pub type R = crate::R<u32, super::PUBLISH_COMPARE>;
#[doc = "Writer for register PUBLISH_COMPARE[%s]"]
pub type W = crate::W<u32, super::PUBLISH_COMPARE>;
#[doc = "Register PUBLISH_COMPARE[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_COMPARE {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event COMPARE\\[n\\] will publish to."]
    #[inline(always)]
