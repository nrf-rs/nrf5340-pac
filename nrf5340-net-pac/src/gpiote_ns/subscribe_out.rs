#[doc = "Reader of register SUBSCRIBE_OUT[%s]"]
pub type R = crate::R<u32, super::SUBSCRIBE_OUT>;
#[doc = "Writer for register SUBSCRIBE_OUT[%s]"]
pub type W = crate::W<u32, super::SUBSCRIBE_OUT>;
#[doc = "Register SUBSCRIBE_OUT[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_OUT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task OUT\\[n\\] will subscribe to"]
    #[inline(always)]
