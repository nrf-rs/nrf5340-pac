#[doc = "Reader of register PUBLISH_PORT"]
pub type R = crate::R<u32, super::PUBLISH_PORT>;
#[doc = "Writer for register PUBLISH_PORT"]
pub type W = crate::W<u32, super::PUBLISH_PORT>;
#[doc = "Register PUBLISH_PORT `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_PORT {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event PORT will publish to."]
    #[inline(always)]
