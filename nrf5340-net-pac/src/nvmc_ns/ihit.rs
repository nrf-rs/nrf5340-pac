...
impl core::convert::From<crate::R<IHIT_SPEC>> for R {
...
impl core::convert::From<crate::W<IHIT_SPEC>> for W {
    fn from(writer: crate::W<IHIT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `HITS` reader - Number of cache hits Write zero to clear"]
...
#[doc = "Field `HITS` writer - Number of cache hits Write zero to clear"]
pub struct HITS_W<'a> {
    w: &'a mut W,
}
impl<'a> HITS_W<'a> {
