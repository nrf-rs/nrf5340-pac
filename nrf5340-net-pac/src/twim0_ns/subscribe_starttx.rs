#[doc = "Reader of register SUBSCRIBE_STARTTX"]
pub type R = crate::R<u32, super::SUBSCRIBE_STARTTX>;
#[doc = "Writer for register SUBSCRIBE_STARTTX"]
pub type W = crate::W<u32, super::SUBSCRIBE_STARTTX>;
#[doc = "Register SUBSCRIBE_STARTTX `reset()`'s with value 0"]
impl crate::ResetValue for super::SUBSCRIBE_STARTTX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that task STARTTX will subscribe to"]
    #[inline(always)]
