...
impl core::convert::From<crate::R<EVENTS_LASTRX_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_LASTRX_SPEC>> for W {
...
pub struct EVENTS_LASTRX_R(crate::FieldReader<bool, EVENTS_LASTRX_A>);
...
impl core::ops::Deref for EVENTS_LASTRX_R {
    type Target = crate::FieldReader<bool, EVENTS_LASTRX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
