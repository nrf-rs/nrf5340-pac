#[doc = "Reader of register PUBLISH_TXSTARTED"]
pub type R = crate::R<u32, super::PUBLISH_TXSTARTED>;
#[doc = "Writer for register PUBLISH_TXSTARTED"]
pub type W = crate::W<u32, super::PUBLISH_TXSTARTED>;
#[doc = "Register PUBLISH_TXSTARTED `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_TXSTARTED {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event TXSTARTED will publish to."]
    #[inline(always)]
