#[doc = "Reader of register PUBLISH_LASTRX"]
pub type R = crate::R<u32, super::PUBLISH_LASTRX>;
#[doc = "Writer for register PUBLISH_LASTRX"]
pub type W = crate::W<u32, super::PUBLISH_LASTRX>;
#[doc = "Register PUBLISH_LASTRX `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_LASTRX {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event LASTRX will publish to."]
    #[inline(always)]
