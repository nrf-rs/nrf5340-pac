#[doc = "Reader of register PUBLISH_POFWARN"]
pub type R = crate::R<u32, super::PUBLISH_POFWARN>;
#[doc = "Writer for register PUBLISH_POFWARN"]
pub type W = crate::W<u32, super::PUBLISH_POFWARN>;
#[doc = "Register PUBLISH_POFWARN `reset()`'s with value 0"]
impl crate::ResetValue for super::PUBLISH_POFWARN {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:7 - Channel that event POFWARN will publish to."]
    #[inline(always)]
