...
impl core::convert::From<crate::R<EVENTS_SLEEPEXIT_SPEC>> for R {
...
impl core::convert::From<crate::W<EVENTS_SLEEPEXIT_SPEC>> for W {
...
pub struct EVENTS_SLEEPEXIT_R(crate::FieldReader<bool, EVENTS_SLEEPEXIT_A>);
impl EVENTS_SLEEPEXIT_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVENTS_SLEEPEXIT_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> EVENTS_SLEEPEXIT_A {
        match self.bits {
            false => EVENTS_SLEEPEXIT_A::NOTGENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        **self == EVENTS_SLEEPEXIT_A::NOTGENERATED
    }
...
impl core::ops::Deref for EVENTS_SLEEPEXIT_R {
    type Target = crate::FieldReader<bool, EVENTS_SLEEPEXIT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> EVENTS_SLEEPEXIT_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: EVENTS_SLEEPEXIT_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_SLEEPEXIT_A::NOTGENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
