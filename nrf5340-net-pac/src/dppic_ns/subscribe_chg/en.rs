...
impl core::convert::From<crate::R<EN_SPEC>> for R {
...
#[doc = "Field `CHIDX` reader - DPPI channel that task CHG\\[n\\].EN will subscribe to"]
...
#[doc = "Field `CHIDX` writer - DPPI channel that task CHG\\[n\\].EN will subscribe to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that task CHG\\[n\\].EN will subscribe to"]
    #[inline(always)]
